...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题确认是否出现过指向具体对象的、明确的性欲望。重点不是是否发生过性行为，而是对方是否进入过您的性幻想、性接触欲望或明显性兴奋范围，并与审美欣赏、好感和情感亲近区分。作答时请把一次特殊例外与近几年反复出现的模式分开看待。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估性吸引是否会形成接近对象或发起性互动的内在驱动力。这里看的是欲望本身，不要求您真的行动，也要排除安全、关系边界等现实因素造成的克制。作答时请把一次特殊例外与近几年反复出现的模式分开看待。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察性吸引对象的范围是否较广。它不是要求您对所有类型都同样有感觉，而是看吸引是否只会被一个非常狭窄、固定的对象模板触发。作答时请把一次特殊例外与近几年反复出现的模式分开看待。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估性吸引在幸福感中的重要程度。重点不是社会是否把性关系视为必需，而是当您长期没有性吸引或性关系时，自己是否会持续感到空缺或受影响。作答时请把一次特殊例外与近几年反复出现的模式分开看待。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题了解您希望性行为在亲密关系中占据什么位置。它不是评价关系是否完整，而是比较完全无性的关系、偶尔参与和把性视为重要组成部分，哪一种更符合您的愿望。行为、态度与吸引可能不同，请按题目实际询问的层面作答。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题考察您能否把想恋爱与想发生性接触分开识别。两种吸引可以同时出现，也可以彼此独立；高分表示能依据关系想象、性幻想和身体欲望辨别差异。浪漫吸引和性吸引可以同步，也可以彼此分离。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察文化、家庭和社会环境是否会改变您的浪漫表达方式。这里关注表达形式的变化，例如陪伴、仪式或身体亲近的比重，而不是判断哪种文化更浪漫。浪漫吸引和性吸引可以同步，也可以彼此分离。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察情感吸引是否会因对象、信任程度和关系情境而明显变化。高分表示您对不同关系投入的情感深度差异较大，不代表关系价值存在高低。关系名称不决定吸引性质，请以实际渴望和体验为准。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估您是否会主动把情感联结的需要转化为行动。主动分享经历、发起深入谈话或共同完成重要事情，都可视为建立深层关系的尝试。关系名称不决定吸引性质，请以实际渴望和体验为准。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察审美欣赏是否会自然转化为接近、触碰或发展关系的冲动。重点是能否满足于观看和感受美，而不是您现实中是否会克制行动。审美吸引可以很强烈，但不必自动包含性意味。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题通过观察您对并非潜在性吸引对象之人的欣赏，了解审美吸引能否独立于性取向存在。请关注自己是否真切感受到外貌、气质或造型之美，而不是是否认同某种审美标准。审美吸引可以很强烈，但不必包含性意味。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题考察您能否区分感官吸引与性吸引。可以参考触碰是否只是为了安慰、温暖和亲近，还是伴随性唤起、性幻想或进一步性接触的欲望。相同动作可能具有不同性质，请结合内在欲望判断。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估您是否会主动表达非性身体接触的需要。高分指能在尊重对方边界并取得同意的前提下提出请求，而不是未经确认直接触碰。相同动作可能具有不同性质，请结合内在欲望判断。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题关注您是否察觉自己的吸引模式与常见社会脚本不同。差异感可能来自很少体验性吸引、难以理解相关谈资，或更重视其他亲密形式，但它本身不等于任何固定身份。这些题只记录探索状态，不要求使用或公开任何标签。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估您对自身吸引模式的接纳程度。接纳并不要求使用某个标签或公开身份，而是能把真实体验视为有效，并根据自己的需要建立关系和边界。这些题只记录探索状态，不要求使用或公开任何标签。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察您是否主动通过资料、社群或他人经验了解无性恋谱系。这里衡量探索程度，不要求加入社群；偶尔阅读术语与持续系统了解可以按投入程度区分。这些题只记录探索状态，不要求使用或公开任何标签。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题评估您是否会在关系中沟通吸引体验、性行为态度和身体边界。沟通可以使用具体需要而非身份标签，重点是让双方在知情和同意的基础上理解彼此。这些题只记录探索状态，不要求使用或公开任何标签。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察了解谱系概念后，自我理解是否变得更清晰。有效的知识可能帮助您区分吸引类型、重新解释过往经历或减少自责，但不要求因此确定唯一标签。这些题只记录探索状态，不要求使用或公开任何标签。</p>
...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察您是否更偏好在双方同意的性互动中作为接受者，由对方发起或引导。它描述互动角色偏好，不代表必须接受任何行为，也不等同于缺少自主性。相关术语只是描述线索，单题高分不能证明某种身份。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察您是否更偏好在双方同意的性互动中给予对方愉悦，而不期待自己被满足。它关注满足感来源和角色偏好，不要求忽视自身边界或承担取悦义务。相关术语只是描述线索，单题高分不能证明某种身份。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察“性吸引”这一概念是否难以与您的内在体验对应，也就是疑性恋线索。重点不是知识不足，而是即使理解定义和案例，仍无法判断这个概念是否适用于自己。相关术语只是描述线索，单题高分不能证明某种身份。</p>
	...
	<div class="question">
		...
		<div class="explanation">
									<p><strong>本题用意：</strong>本题观察您是否难以把性吸引从审美、情感或浪漫吸引中单独辨认，也就是吸引模糊性恋线索。它关注类型之间的边界，而不是吸引本身强不强。相关术语只是描述线索，单题高分不能证明某种身份。</p>
	...
	function generateSectionScoresTable(scores) {
		...
		const describeSection = (name, avg) => {
			...
			const descriptions = {
				...
				'情感吸引': avg >= 3.5 ? '您较重视理解、倾诉与深层情感连接，这种连接可以完全不包含性吸引。' : avg >= 2.5 ? '情感连接需求会随关系与信任程度变化，并非对所有对象都同样明显。' : '主动建立深层情感连接的倾向较低，可能更依赖少数关系、时间或安全感。',
				'审美吸引': avg >= 3.5 ? '您较常欣赏外貌、气质或风格，但“觉得好看”本身不能作为存在性吸引的证据。' : avg >= 2.5 ? '审美欣赏存在但并非持续主轴，可能集中在特定风格或对象。' : '外貌与气质带来的欣赏较少，或不是您注意他人的主要方式。',
				'感官吸引': avg >= 3.5 ? '您较明确地渴望拥抱、依偎或非性触碰；需要把触觉亲密与性接触愿望分开理解。' : avg >= 2.5 ? '非性身体亲密的需求受对象、边界与安全感影响较大。' : '对拥抱、依偎等非性触碰的主动需求较低，个人边界可能更重要。',
				'自我认知': avg >= 3.5 ? '您较能识别、接纳并沟通自己的吸引模式，当前结果更适合用于细化描述。' : avg >= 2.5 ? '您已形成部分理解，但标签、差异感与沟通方式仍在探索中。' : '您可能仍在辨别体验与学习相关概念，当前分数更适合作为问题清单，而不是身份结论。'
			};
