...
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题旨在探究性吸引最核心的元素：对他人产生的、以性为导向的内在欲望。这用于将其与单纯的欣赏或喜欢（如审美吸引、情感吸引）区分开来。如果您的体验中包含具体的性行为渴望（如不由自主地想"触摸TA的身体"并感到兴奋），则更偏向有性恋；反之，如果从未有过这种具体、强烈的性导向冲动，则可能位于无性恋谱系。请回想一生中是否有过这种"无法忽略的性渴望"，而非只是"觉得TA不错"。这种欲望往往是本能的，让人难以忽略。通过此题，我们可以初步评估性吸引在您经历中的基础存在性。该题帮助量化内在冲动的具体性和强度，以作为谱系定位的起点。
			</p>
			<p><strong>具体案例：</strong>例一：若您在工作场合遇到某位同事时，会自发地产生与其发生性行为的强烈念头，并伴随心跳加快或生理性兴奋，则可选择5分；相反，若您从未对他人产生过明确的性冲动，仅停留在对方"令人吸引"或"好感"的情感层面，则可选择0分。例二：若您在青少年时期对同学的喜欢仅限于希望与其相处、玩耍，而无任何性行为想象，则评分较低。例三：若您在社交场合（如派对）中注视陌生人时，会产生具体的性幻想并伴随生理兴奋，则评分较高。
			</p>
		</div>
	</div>
	<!-- 2 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题聚焦于性幻想的自发性，它是内在性吸引的直接表现。有性恋者通常会不由自主地产生性幻想（如突然脑中闪现与TA的亲密画面）。若您的性幻想很少、需刻意构思，或完全没有这种自发性，这可能表明您的性吸引较弱或有特定条件，更接近无性恋谱系的特征。请思考：这种幻想是否"自动出现"，伴随兴奋，而非您主动"强迫自己想"。自发幻想往往在日常情境中发生。通过此题，我们评估性吸引的自动化程度，以区分本能驱动与有意识构建。该题还考虑幻想的频率和触发机制，以提供对认知过程的深入洞察。
			</p>
			<p><strong>具体案例：</strong>例一：当您在公交车上看到一位陌生人时，若脑海中自发浮现出与其发生性行为的具体场景，并伴随心理或生理兴奋，则可选择5分；相反，若仅在接触相关情境（如阅读或观看）时才会刻意想象，且缺乏自发的兴奋体验，则可选择0分。例二：若您对电影明星的欣赏仅停留在回味剧情或画面本身，而无任何自发的性幻想，则为低分。例三：若您在日常通勤或工作场合中，会不由自主地产生与同事发生性行为的幻想，则为高分。
			</p>
		</div>
	</div>
	<!-- 3 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题关注性吸引的生物学标志——身体的自发反应。这些生理现象通常是无法靠意志控制的（如看到TA时下体自动反应），能有力地证明性吸引的存在。若您很少或从未因特定的人产生这类反应（如只因紧张心跳加速，但无性相关变化），这是无性恋谱系的一个重要指标。请回想：这种反应是否明确指向性欲，而非其他情绪（如害怕或兴奋）。身体反应是诚实的信号，帮助我们辨识内在驱动力。通过此题，我们量化生理指标在性吸引识别中的作用。该题强调反应与特定对象的关联，以排除一般生理响应。
			</p>
			<p><strong>具体案例：</strong>例一：当您与一位朋友交谈时，若突然出现生理性反应（如明显的性兴奋）并伴随对对方产生性行为的渴望，则可选择5分；相反，若您的生理反应仅表现为一般的兴奋或紧张（如出汗、心率加快），且无明确性指向，则可选择0分。例二：若您在聚会中注视某人时仅出现面部泛红等轻微反应，而无性兴奋或生殖器反应，则为低分。例三：若您在约会中因伴侣的触碰而感受到明显的身体热感与性唤起，则为高分。
			</p>
		</div>
	</div>
	<!-- 4 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>通过评估性吸引的发生频率，本题帮助定位您在"无性恋-灰性恋-有性恋"连续谱上的大致位置。频率极低（如一生中很少）是灰性恋的典型特征，而高频率（如日常常见）则指向有性恋。请根据您的整体人生经历来判断，包括对任何类型对象的吸引，而非仅限浪漫对象。频率揭示吸引的规律性。通过此题，我们建立频率作为谱系定位的量化基准。该题考虑所有对象类型，以确保全面性评估。
			</p>
			<p><strong>具体案例：</strong>例一：若您一生中仅偶尔（约2–3次）对虚构角色产生过性吸引，可选择1分；相反，若您几乎每天在社交媒体上看到名人时都会自发产生性幻想，则可选择4分。例二：若您仅在特定节日或特殊情境下偶尔对路人产生性吸引，可选择2分。例三：若您在日常生活中每周都会较为规律地对同事产生性吸引，可选择3分。
			</p>
		</div>
	</div>
	<!-- 5 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题是判断半性恋（Demisexual）的关键问题。它探讨的是您的性吸引是否以"深厚情感联结"（如数月信任积累）为前提。如果答案是肯定的，即您只对知己或爱人产生性吸引，这便是半性恋的典型特征。如果情感联结并非必要条件（如对陌生人也能有冲动），则更偏向有性恋或灰性恋。请回想：您的任何性吸引是否都需先有情感基础？通过此题，我们隔离条件依赖因素，以识别条件性吸引模式。该题强调联结的深度和持续时间，以区分浅层互动。
			</p>
			<p><strong>具体案例：</strong>例一：若您在与一位相识并相处五年的朋友之间，首次出现性吸引，而此前从未产生过类似感觉，则可选择5分；相反，若您在初次见面时就对陌生人产生性冲动，则可选择1分。例二：若您对大学同学的性吸引仅在毕业聚会后才出现，则可选择4分。例三：若您对新同事起初无任何吸引，直到建立信任后才产生性兴趣，则为高分。
			</p>
		</div>
	</div>
	<!-- 6 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题探讨性吸引的"条件性"，这是灰性恋谱系的另一个常见维度。如果您的性吸引高度依赖于外部或内部的"开关"（如特定的环境、情绪、或对象类型），说明它并非一种持续存在的状态，这与灰性恋的定义相符。反之，不受情境限制的吸引（如随时随地）则更像有性恋。请思考：您的吸引是否总需"特定触发"才能出现？通过此题，我们评估环境和情绪作为性吸引调节变量的程度。该题帮助识别触发因素的类型和频率，以细化条件模式。
			</p>
			<p><strong>具体案例：</strong>例一：若您仅在假期放松、情绪轻松的状态下对伴侣产生性吸引，而在日常工作或紧张环境中无明显感觉，则可选择5分；相反，若您在任何场合（如办公室、会议等）都能轻易产生性吸引，则可选择1分。例二：若您对特定性格类型的个体仅在派对等特定社交环境中产生吸引，则可选择4分。例三：若您在工作压力较大时缺乏性吸引，但在周末或情绪愉悦时出现性兴奋，则可选择3分。
			</p>
		</div>
	</div>
	<!-- 7 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题旨在评估您所体验到的性吸引的"质感"——它的强度和持久性。灰性恋的常见特征便是，即使感受到性吸引，这种感觉也可能是微弱（如模糊的暖流）、模糊或转瞬即逝的（几分钟就淡去）。相反，强烈而持久的吸引（如持续几天、占据思绪）则是有性恋的典型体验。请回想：您的吸引是否总像"浅尝辄止"，缺乏深度？通过此题，我们测量吸引的持续时间和峰值强度，以量化其稳定性。该题考虑消退机制，以区分持久
				vs 瞬时体验。</p>
			<p><strong>具体案例：</strong>例一：若您对某人产生的吸引仅持续约10分钟便迅速消退，可选择5分；相反，若该吸引持续一周以上且多次反复出现，则可选择1分。例二：若您对名人的短暂性幻想仅在观看相关视频时出现，则可选择4分。例三：若您在聚会中对他人产生吸引，但于次日即完全消退，则可选择3分。
			</p>
		</div>
	</div>
	<!-- 8 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>性吸引通常伴随着行动的欲望，此题旨在衡量这种驱动力的强弱。强烈的内在驱动力（如"必须见TA"）是有性恋的标志。而在无性恋谱系中，即使偶尔感受到吸引，也可能缺乏将其付诸实践的迫切感，更像是一种被动的、可有可无的感觉（如想想就过）。请思考：吸引后您是否会"行动起来"，还是就停留在脑海？通过此题，我们评估行为动机与吸引强度的关联。该题聚焦行动类型，以识别驱动力水平。
			</p>
			<p><strong>具体案例：</strong>例一：若您在产生吸引后会立即采取行动，例如主动发送消息并约对方见面，则可选择5分。例二：若您因对同事产生吸引而改变了原有的工作习惯或行为方式，则可选择4分。例三：若您在产生幻想后无进一步计划或行动意图，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 9 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题从"是否需要思考"的角度，探讨性吸引的本能性。对于有性恋者，性吸引常是一种"突如其来"的直觉（如一眼就"砰"的一声）。而对于半性恋或灰性恋，这种感觉可能需要情感或情境的"酝酿"（如需分析"为什么喜欢TA"），并非纯粹的本能反应。请回想：您的吸引是否"瞬间击中"，还是需时间酝酿？通过此题，我们区分认知加工与自动响应在吸引形成中的角色。该题评估即时性，以量化本能成分。
			</p>
			<p><strong>具体案例：</strong>例一：若您在派对上第一眼看到某人便立即产生性吸引，无需任何思考或判断，则可选择5分；相反，若您需要经过数天的观察或分析后才确认对其存在吸引，则可选择1分。例二：若您对陌生人的吸引反应仅在了解其背景信息后才出现，则可选择3分。例三：若您在日常相遇时基于直觉即产生性冲动或兴趣，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 10 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题通过吸引对象的广度来辅助判断。一般来说，有性恋者能被更广泛类型的人所吸引（如各种外貌、性格）。而在无性恋谱系中，即便存在性吸引，其对象也可能极其有限，仅限于极少数符合特定条件的个体（如只对亲密友人）。请统计一生中：吸引对象是否多样，还是极少且特定？通过此题，我们量化对象多样性作为吸引泛化程度的指标。该题考虑类型变量如年龄、性别，以全面评估范围。
			</p>
			<p><strong>具体案例：</strong>例一：若您一生中曾对约10种不同性格类型的人产生过性吸引，则可选择5分；相反，若您的吸引对象仅限于1至2种特定类型，则可选择1分。例二：若您对不同性别的对象均能产生相对均衡的吸引，则可选择4分。例三：若您的吸引主要集中于与自己年龄相仿的人群，则可选择3分。
			</p>
		</div>
	</div>
	<!-- 11 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题衡量性吸引在您生活中的"存在感"或影响力。强烈的性吸引往往会占据思绪，影响注意力和行为决策（如因TA而翘课）。如果性吸引对您来说，即便存在，也几乎不影响您的正常生活（如一闪而过无波澜），这表明它在您的心智活动中优先级较低，更符合谱系特征。请思考：吸引是否曾"干扰"您的日常？通过此题，我们评估吸引对认知和行为资源的占用率。该题聚焦具体影响领域如工作或学习。
			</p>
			<p><strong>具体案例：</strong>例一：若您因对某人产生性吸引而明显影响工作效率或注意力集中，则可选择5分；相反，若该吸引对您的日常工作或生活无明显影响，则可选择0分。例二：若您在学习过程中因性幻想而频繁分心，则可选择4分。例三：若您仅偶尔因吸引而短暂走神，则可选择3分。
			</p>
		</div>
	</div>
	<!-- 12 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题旨在识别无参与性恋(aegosexual)特征。Aegosexual者可能对性内容、情节或虚构角色间的互动感兴趣,但这种兴趣是"旁观式"的——当涉及到自己实际参与时,这种吸引会消失或明显减弱。这反映了性幻想与个人参与欲望之间的分离。关键在于:您能享受性概念,但将自己代入其中时会感到不适或失去兴趣。
			</p>
			<p><strong>具体案例：</strong>例一：若您喜欢阅读浪漫或情色内容,但完全不希望自己经历类似情境,则可选择5分。例二：若您对他人之间的性互动感兴趣,但想象自己参与时感到疏离或不适,则可选择4分。例三：若您偶尔能享受性幻想,但其中的"自己"更像第三人称视角的角色而非真实的您,则可选择3分。例四：若您对性内容和现实性活动的兴趣程度相当,则可选择0分。
			</p>
		</div>
	</div>
	<!-- 13 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题再次探讨性吸引的"本能"与"可控"属性。随机、不受控的体验更接近有性恋的本能驱动。如果性吸引的出现对您来说是可预测、可管理的，甚至是可以"开启"或"关闭"的，这暗示了其条件性，与灰性恋等谱系身份更相关。请回想：吸引是否"失控"出现，还是您能"掌控"？通过此题，我们评估控制感和随机性的平衡。该题考虑抑制能力，以量化可控程度。
			</p>
			<p><strong>具体案例：</strong>例一：若您在日常散步等非特定情境中，会突然对路人产生强烈且难以抑制的性吸引，则可选择5分；相反，若您的性吸引仅在可预期或特定情境下出现，则可选择0分。例二：若您在压力或紧张状态下也会随机出现性吸引，则可选择4分。例三：若您能够通过转移注意力来控制或消除这种吸引，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 14 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>通过考察您是否会主动创造机会来体验性吸引，本题评估性吸引在您生活中的驱动力。主动寻求是需求和欲望的体现，常见于有性恋者。无性恋谱系的人则很少或从不为此做出主观努力。请思考：您是否曾主动寻求，还是被动接受？通过此题，我们测量主动性作为吸引需求的代理变量。该题聚焦努力类型，以评估需求强度。
			</p>
			<p><strong>具体案例：</strong>例一：若您经常使用约会应用主动寻找可能产生性吸引的对象，则可选择5分；相反，若您从不主动寻求此类机会或途径，则可选择0分。例二：若您仅偶尔参加社交活动，且目的主要是维系友情而非寻求吸引，则可选择3分。例三：若您频繁参加派对或聚会，目的是希望获得他人的关注或激发性吸引，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 15 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>通过评估性吸引对您幸福感的影响，本题旨在判断它在您人生中的核心地位。如果缺少性吸引或性关系并不会让您感到空虚或不幸，这表明您的幸福感建立在其他基础之上，更符合无性恋谱系的特征。请想象：无性生活是否仍快乐？通过此题，我们链接吸引体验与整体福祉的关联。该题评估优先级，以识别核心驱动力。
			</p>
			<p><strong>具体案例：</strong>例一：若您认为即使没有性吸引的生活也同样充实且满足，则可选择0分；相反，若您在缺乏性吸引时会感到空缺或失落，则可选择4分。例二：若您倾向于优先投入事业、学习或个人目标，而相对忽略性吸引或情感关系，则可选择1分。例三：若您无法忍受没有性吸引存在的生活，则可选择5分。
			</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题用于判断您的性行为态度（性排斥/无感/友好），它与是否存在性吸引是两个独立维度。一个无性恋者，可能因为厌恶性行为而从不参与，也可能因为对伴侣的爱或享受身体快感而持友好态度。请聚焦态度本身，而非吸引：性行为对您是排斥、中性还是积极？通过此题，我们分离态度维度以全面描绘行为倾向。该题考虑态度稳定性，以评估长期偏好。
			</p>
			<p><strong>具体案例：</strong>例一：若您在想到性行为时会产生明显的生理或心理不适，如反感、紧张或排斥感，则可选择0分；相反，若您将性行为视为一种可选择但非必要的活动，则可选择3分。例二：若您因好奇而尝试性行为，但过程中无明显厌恶或抵触情绪，则可选择4分。例三：若您在性行为中能强烈感受到愉悦并享受生理过程，则可选择5分。
			</p>
		</div>
	</div>
	<!-- 17 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题旨在剖析您参与性行为的真实动机。对于无性恋谱系的人来说，参与性行为的动机往往是外在的（如维持关系、满足好奇、社会期望）而非内在的性欲驱动。明确自己的动机，有助于更好地沟通和建立健康的亲密关系。请列出原因：是外在因素还是内在欲求？通过此题，我们识别动机来源以区分内在
				vs 外在驱动。该题列举常见动机，以促进自我分类。</p>
			<p><strong>具体案例：</strong>例一：若您参与性行为的主要动机是为了维系关系或避免冲突，而非出于自身欲望，则可选择0分；相反，若您参与性行为主要是为了满足个人的性欲或生理需求，则可选择5分。例二：若您因出于好奇或探索心理而参与性行为，则可选择1分。例三：若您在社会或伴侣压力下被动参与性行为，则可选择2分。
			</p>
		</div>
	</div>
	<!-- 18 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题通过您对大众性文化的反应，来反观您的内在体验。普遍的性文化对于无性恋谱系的人来说，可能难以产生共鸣。这种隔阂感是谱系身份的常见佐证之一。请回想媒体反应：无感、不适还是兴趣？通过此题，我们使用媒体反应作为态度代理指标。该题覆盖多种媒体类型，以评估一致性。
			</p>
			<p><strong>具体案例：</strong>例一：若您在观看色情影片时感到困惑、冷漠或毫无兴奋感，则可选择0分；相反，若您在观看时产生强烈兴趣或明显的性兴奋反应，则可选择5分。例二：若您在看到含性暗示的广告或画面时感到不适或排斥，则可选择1分。例三：若您仅在特定情境下偶尔对相关内容产生兴趣，则可选择3分。
			</p>
		</div>
	</div>
	<!-- 19 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题直接探讨您对无性关系的偏好程度。高度愿意构建一种不含性元素的亲密关系，是理解无性恋倾向的重要参考。这表明对您而言，亲密关系的核心在于情感、陪伴等其他方面，而非性。请想象理想关系：性是否必需？通过此题，我们评估行为回避作为关系偏好的指标。该题考虑替代亲密形式，以确认偏好完整性。
			</p>
			<p><strong>具体案例：</strong>例一：若您理想中的亲密关系以情感联结为核心，没有性行为也能感到满足与完整，则可选择0分；相反，若您认为性行为是维系关系的必要组成部分，则可选择5分。例二：若您在关系中经常避免性行为，更重视情感互动，则可选择1分。例三：若您在亲密关系中主要关注交流、陪伴与情感支持，但也积极参与性互动，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 20 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>通过评估性行为后的感受，本题可以反映出该行为是否真正契合您的内在需求。如果事后的感受总是负面的，例如觉得空虚或疏离感，这可能表明您的参与并非源于真实欲望。请回想事后情绪：满足还是不适？通过此题，我们考察后体验以验证行为一致性。该题聚焦情绪类型，以识别不匹配信号。
			</p>
			<p><strong>具体案例：</strong>例一：若您在性行为结束后经常感到情感疏离、空虚或失落，则可选择5分；相反，若您在事后主要感受到满足与放松，则可选择1分。例二：若您偶尔在性行为后感到后悔或轻微不安，则可选择3分。例三：若您在性行为后经常出现心理或生理上的不适，则可选择4分。
			</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题旨在帮助您梳理是否存在浪漫吸引，这是与性吸引分离的独立概念。许多无性恋者有浪漫倾向，TA们渴望爱情，只是不渴望性。反之，不存在浪漫吸引的人属于无浪漫谱系。请区分：您的"爱"是否包括约会幻想，而非性？通过此题，我们隔离浪漫维度以识别其独立强度。该题评估浪漫行为的多样性，以全面描绘倾向，并帮助您理解浪漫在无性恋谱系中的角色，如构建无性浪漫关系。
			</p>
			<p><strong>具体案例：</strong>例一：若您经常幻想与某人牵手散步、互赠情书或庆祝纪念日等浪漫情境，而其中不包含任何性元素，则可选择5分；相反，若您对任何形式的恋爱活动都缺乏兴趣，仅满足于一般性的日常互动，则可选择0分。例二：若您偶尔在节日期间会产生想与朋友发展为恋人关系的念头，则可选择3分。例三：若您会对虚构角色产生浪漫幻想，例如想象与其共同冒险或分享情感，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 22 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此问题评估"浪漫"在您人生价值排序中的位置。高分表明您有强烈的浪漫倾向，将恋爱视为人生幸福的重要组成部分。低分则可能指向无浪漫谱系，即不认为恋爱是人生的必需品。请优先级排序：浪漫
				vs
				其他满足？通过此题，我们评估浪漫对福祉的贡献度。该题考虑缺失感强度，以量化重要性，并链接到谱系整体，如浪漫吸引可独立于性吸引存在，支持"异性浪漫倾向无性恋"、"同性浪漫倾向无性恋"等身份。
			</p>
			<p><strong>具体案例：</strong>例一：若您认为没有浪漫关系的生活会感到空虚，仿佛缺失了人生中重要的一部分，则可选择5分；相反，若您认为友情、自我成长或个人理想已足以带来满足，无需通过恋爱来获得完整感，则可选择0分。例二：若您偶尔在看到情侣时会感到轻微的羡慕或向往，但总体情绪平稳，则可选择3分。例三：若您将浪漫关系视为人生的重要目标之一，并倾向于围绕其规划未来（如婚姻或长期伴侣关系），则可选择4分。
			</p>
		</div>
	</div>
	<!-- 23 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>对于无性恋谱系的人来说，清晰地区分不同类型的吸引是认识自我的关键一步。有性恋者常常将两者混为一谈，而无性恋者则更能体会到纯粹的浪漫吸引。请测试：您的"心动"中，浪漫元素是否独立于性？通过此题，我们测试类型分离能力。该题帮助识别混淆来源，以提升辨识技能，并为谱系探索提供参考，避免将浪漫误判为性吸引。
			</p>
			<p><strong>具体案例：</strong>例一：若您能清晰地将对某人的心动体验描述为"希望与其共同生活、旅行与分享情感"，但完全不包含身体亲密或性欲求，则可选择5分；相反，若您在产生心动时总会伴随性幻想，且难以将情感与性吸引区分，则可选择0分。例二：若您有时需要经过反思或回忆才能判断自己的情感是浪漫还是性吸引，则可选择3分。例三：若您通过记录、书写或自我分析后，能较为清晰地区分两者，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 24 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题探讨浪漫吸引的文化和社会适应性，帮助您反思浪漫在不同语境中的灵活表现。浪漫吸引可能受文化影响而调整表达，例如在强调情感仪式的环境中，更侧重写信或共享回忆，而非身体接触。这有助于区分浪漫的本质（情感联结）与外部形式，尤其在无性恋谱系中，理解这种适应性能增强对多元关系的包容。请思考：您的浪漫幻想是否随环境变化，却始终保持情感核心？通过此题，我们考察文化调节效应。该题评估适应程度，以识别灵活性，并提供跨文化视角以科学深化自我认知。
			</p>
			<p><strong>具体案例：</strong>例一：若您在传统节日期间更注重通过交换礼物、讲述故事或表达情感来传递浪漫，而非以亲吻或身体接触为主要方式，则可选择5分；相反，若您的浪漫表达方式在不同文化或情境下基本不变、缺乏调整，则可选择1分。例二：若您偶尔受西方浪漫文化（如电影或节日）的影响，会尝试烛光晚餐等表达方式，则可选择3分。例三：若您在家庭或文化背景中更倾向通过情感性仪式（如共进晚餐、节日陪伴）来表达浪漫，则可选择4分。
			</p>
		</div>
	</div>
	<!-- 25 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题考察浪漫吸引的独立性，观察其是否不受性吸引影响。高分表明浪漫吸引可单独存在，如无性恋者常体验的"纯浪漫"。低分则可能表示两者融合，常见于有性恋。请反思：浪漫心动是否总伴随性欲？通过此题，我们评估分离度，以强化谱系的维度划分。该题帮助识别独立机制，提供科学洞察如浪漫可作为补偿性满足。
			</p>
			<p><strong>具体案例：</strong>例一：如果您经常对某人产生浪漫幻想，例如希望与对方共度时光、一起看电影，但完全没有性方面的想法，可选择5分；相反，若您的浪漫情感始终伴随强烈的性欲或性幻想，则可选择0分。例二：如果您偶尔会在浪漫与性吸引之间保持一定独立性，可选择3分。例三：如果您的关系中浪漫情感明显主导，而性欲较弱或依附于浪漫，可选择4分。
			</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题作为情感吸引维度的"锚点"，旨在帮助您系统梳理是否将"深层非浪漫、非性的人际连接"视为内在需求的核心组成部分。不同于浪漫吸引（指向恋爱仪式）或感官吸引（指向身体舒适），情感吸引聚焦于"灵魂共振"——一种渴望与他人共享内在世界、建立无条件信任、共同成长的驱动力。在无性恋谱系中，情感吸引往往成为性吸引缺失后的"主要补偿机制"，研究（AVEN
				2022 Survey）显示，约 68%
				的无性恋者将"深厚友谊"列为幸福感首要来源。本题通过"是否主动渴望"这一行为倾向指标，量化您对"知己型关系"的依赖程度。高分者通常表现出"情感饥饿"特征：即使拥有大量浅层社交，仍感到内在空虚；低分者则更倾向于"高质量独处"或"选择性深交"。通过此题，我们可建立情感吸引的"基线强度"，为后续区分浪漫/情感边界提供参照。
			</p>
			<p><strong>具体案例：</strong>例一：您在大学期间遇到一位同学，初次交谈后即产生强烈愿望——"我想与TA分享我最隐秘的童年创伤，倾听TA的梦想，并成为彼此成长的见证者"，这种冲动超越普通友谊，指向灵魂层面的"被看见"需求，可选择5分；例二：您满足于同事间的寒暄，从未主动寻求深夜长谈或情感暴露，可选择0分；
				例三：仅在特定情境（如失恋后）短暂渴望倾诉对象，可选择3分；例四：定期与2-3位密友进行"人生复盘"式对话，并视其为生活必需，可选择4分。
			</p>
		</div>
	</div>
	<!-- 27 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题从"缺失感"这一负向情绪指标切入，评估情感吸引在您"主观幸福感模型"中的权重占比。心理学研究（Baumeister & Leary,
				1995）证明人类具有"归属需求"，但个体差异显著：有性恋者常将归属感投射于浪漫/性关系，而无性恋谱系者更倾向于将归属感锚定于"情感深度"。本题通过"没有深友是否引发持续性孤独感"这一操作化定义，量化情感吸引的"功能性价值"。高分者往往表现出"情感依赖型人格"特征：深友网络的波动直接影响情绪基线；低分者则更接近"自足型人格"：独处即能产生内在充实感。通过此题，我们可绘制"情感吸引→幸福感"的因果链条，为个性化建议（如"是否需主动拓展深友圈"）提供数据支撑。
			</p>
			<p><strong>具体案例：</strong>例一：您曾因唯一知己搬离城市而陷入长达数月的"存在性空虚"，每日独处时反复回想往日对话，可选择5分；例二：您更享受独处阅读或创作，即使数月无深层对话也感到充实，可选择0分；例三：仅在重大人生节点（如升职或失恋）短暂渴望倾诉，可选择3分；例四：将"每周一次深度对话"视为心理健康的例行维护，可选择4分。
			</p>
		</div>
	</div>
	<!-- 28 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题测试"吸引类型分辨能力"（Attraction Differentiation
				Skill），这是自我认知成熟度的关键指标。在无性恋谱系中，清晰区分情感/浪漫/性吸引能显著降低"身份困惑"与"关系冲突"。研究（Bogaert, 2015）发现，约 42%
				的无性恋者在早期因混淆"强烈情感=浪漫"而误入传统恋爱，导致后续性压力。本题通过"主观分辨信心"这一元认知维度，评估您对内在体验的"标签化精度"。高分者通常已形成"吸引分类系统"：能用具体词汇（如"这是灵魂共鸣，不是心动"）描述差异；低分者则常陷入"模糊地带"：情感升温时无法判断是否滑向浪漫。通过此题，我们可识别"是否需进行吸引类型训练"，为后续干预（如认知行为练习）提供靶点。
			</p>
			<p><strong>具体案例：</strong>例一：您能精确描述"对A的感觉是'深夜倾诉后如释重负的信任感'，对B是'想一起看日落并牵手的悸动'，对C是'想拥抱但无性幻想的温暖'，三者边界清晰，可选择5分；例二：每次"心动"都无法判断是友情升温还是恋爱萌芽，可选择0分；例三：需通过"是否有约会幻想"这一外部标准辅助判断，可选择3分；例四：已形成个人"吸引分类表"，能快速归类，可选择4分。
			</p>
		</div>
	</div>
	<!-- 29 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题考察情感吸引的"动态性"与"情境依赖性"，揭示您是否将情感联结视为"关系特定属性"而非"人格恒定特质"。社会网络理论（Granovetter,
				1973）区分了"强连接"与"弱连接"，本题通过"强度波动"这一指标，量化您在不同关系中的"情感投资弹性"。高分者通常表现出"选择性深度"模式：仅对极少数人开放全部内在世界，对多数人保持礼貌距离；低分者则更接近"均匀分布"模式：情感深度在关系间无显著差异。通过此题，我们可判断您是否属于"情感稀缺资源分配者"（高分）或"情感普惠主义者"（低分），为关系策略建议（如"是否需扩大筛选池"）提供依据。
			</p>
			<p><strong>具体案例：</strong>例一：您对A的情感深度达10分（可分享创伤），对B仅2分（仅聊天气），对C为8分（可共创项目），强度跨度大，可选择5分；例二：所有关系情感深度稳定在3-4分，无明显阶梯，可选择0分；例三：仅在特定领域（如兴趣相同）深度加成，可选择3分；例四：随信任积累呈阶梯式递增，可选择4分。
			</p>
		</div>
	</div>
	<!-- 30 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题评估"情感吸引的主动建构行为"，这是将内在需求外化为行动的关键转化环节。依附理论（Bowlby,
				1969）指出，安全型依附者更倾向于主动寻求亲密，而回避型则被动等待。本题通过"是否主动发起深度对话/经历共享"这一可观察行为，量化您的"情感寻求主动性"。高分者通常已将"深友建设"纳入生活例程，视其为心理健康投资；低分者则更倾向于"被动接受"或"独处满足"。通过此题，我们可识别"是否需进行社交技能训练"（如"如何开启脆弱性对话"），并为关系满意度预测提供行为预测变量。
			</p>
			<p><strong>具体案例：</strong>例一：您定期发起"人生复盘会"，主动邀请朋友共进深度晚餐或周末露营分享，可选择5分；例二：从不主动，仅在对方开口时回应，可选择0分；例三：仅在对方先暴露脆弱性后跟进，可选择3分；例四：已形成"每月一次深度对话"习惯，可选择4分。
			</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题直接测试"视觉愉悦→性欲"的自动链接强度,是区分纯审美与性化审美的核心指标。神经科学研究表明,审美欣赏激活前额叶皮层(理性评价),而性欲激活边缘系统(本能冲动)。本题通过"伴随频率"量化两者的神经耦合度。高分者能体验"视觉盛宴"而大脑不自动跳转至性场景;低分者则任何美感都会触发"下一步想象"。
			</p>
			<p><strong>具体案例：</strong>例一：看到超模走秀时,您的注意力完全在服装线条、光影效果和气场上,脑海中没有任何与对方发生关系的画面,这非常符合5分;相反,如果每次看到美丽的人都会自动产生性幻想或身体反应,这则符合0分。例二：欣赏时偶尔闪现性念头但能立即拉回则可选择4分。例三：美感与性幻想各占一半则可选择2分。例四:多数时候会产生性联想,仅偶尔纯欣赏,则可选择1分。
			</p>
		</div>
	</div>
	<!-- 32 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题评估"审美终止点"——欣赏是否会自然演化为行为欲求。心理学研究显示,性吸引的核心特征是"接近动机"(想缩短距离),而纯审美吸引则可"远观而不亵玩"。本题通过"持续时长+行为冲动"双维度,测试审美体验的"自足性"。高分者的审美如同观赏博物馆展品——满足于观看本身;低分者则审美必然转化为"想要拥有"的占有欲。
			</p>
			<p><strong>具体案例：</strong>例一：您可以在咖啡馆对面安静欣赏某人的侧脸轮廓一小时,内心充满愉悦但完全没有"过去搭讪"或"发生点什么"的念头,这非常符合5分;相反,如果超过几分钟就会产生强烈的接近或肢体接触欲望,这则符合0分。例二：能欣赏但偶尔冒出"要是能..."的想法则可选择4分。例三：欣赏10分钟后开始幻想互动场景则可选择2分。例四:很快就从欣赏转向"怎么认识TA",则可选择1分。
			</p>
		</div>
	</div>
	<!-- 33 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题揭示"美学判断"与"性意图"的语义绑定程度，是防止"审美性化"的关键辨识点。语言心理学表明,词汇的内隐联想反映深层认知模式。本题通过"称赞=性邀约?"这一社交解码,测试您的"审美-性欲"概念边界。高分者的"好看"纯粹是美学鉴赏(如评价艺术品);低分者的"好看"则暗含性评估(如择偶筛选)。
			</p>
			<p><strong>具体案例：</strong>例一：您说"这个人五官精致"的心态完全等同于说"这幅画构图精妙",两者都是客观美学分析,没有任何"然后呢"的性暗示,这非常符合5分;相反,如果每次夸人好看都意味着"符合我的性对象标准",这则符合0分。例二：称赞时偶尔带有性评估意味则可选择4分。例三：一半是纯审美一半是性吸引判断则可选择2分。例四:多数时候暗含性意图,仅对明显不感兴趣的人才纯欣赏,则可选择1分。
			</p>
		</div>
	</div>
	<!-- 34 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题通过"跨性取向审美"测试审美吸引的"性别中立性",是验证"审美≠性欲"的决定性证据。如果审美必然绑定性欲,则只能欣赏"潜在性对象";若审美独立,则可跨性别、跨物种(如动物之美)欣赏。本题通过"非性对象审美强度"反向证明审美吸引的纯粹性。高分者对美的感知不受性取向限制;低分者则审美高度"择偶化"。
			</p>
			<p><strong>具体案例：</strong>例一：作为直男,您可以对男性超模的肌肉线条、面部轮廓赞叹不已,这种欣赏与看雕塑作品无异,完全无性意味,这非常符合5分;相反,如果只能欣赏符合您性取向的性别,对其他性别完全无感,这则符合0分。例二：能欣赏但强度明显低于性取向对象则可选择4分。例三：偶尔被非性取向对象的美打动则可选择2分。例四:极少数情况下才会跨性别欣赏,则可选择1分。
			</p>
		</div>
	</div>
	<!-- 35 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题捕捉"初见反应"这一最原始、最未经修饰的吸引类型,是区分审美与性欲的"第一现场"。认知心理学的"双加工理论"表明,直觉反应(System
				1)比理性判断更能揭示真实倾向。本题通过"即时反应类型"观察您的吸引默认模式。高分者的大脑将美感归档为"感官愉悦",如同闻到花香;低分者则立即启动"求偶程序"。</p>
			<p><strong>具体案例：</strong>例一：地铁上看到气质出众的人,您的内心独白是"天哪这光影下的侧脸太有艺术感了",然后继续做自己的事,没有任何进一步念头,这非常符合5分;相反,如果立即开始盘算"怎么搭讪/要联系方式/有没有可能发展",这则符合0分。例二：先欣赏后偶尔想到互动可能则可选择4分。例三：欣赏与行动意图同时出现则可选择2分。例四:主要想法是如何接近,审美只是附带,则可选择1分。
			</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题作为感官吸引维度的"核心定义题"，旨在确认您是否将"非性身体接触"视为独立于性欲的"舒适需求"。触觉神经科学（Gallace & Spence,
				2010）表明，C-触觉纤维介导的"社交触碰"（如轻柔抚摸）激活岛叶，产生"被关怀"感，而性触碰激活性相关脑区。本题通过"是否主动渴望非性触碰"量化感官吸引的"功能性动机"。在无性恋谱系中，感官吸引常被误解为"隐性性欲"，导致关系边界模糊。本题帮助建立"触碰≠性"的认知。高分者通常将拥抱视为"情绪充电站"；低分者则对触觉需求极低。
			</p>
			<p><strong>具体案例：</strong>例一：在压力大时，第一反应是"想找人抱一抱"，仅为寻求安全与安慰，无任何性联想，可选择5分；例二：从不主动寻求身体接触，也不在意他人是否触碰自己，可选择0分；例三：仅在特定情境（如观看恐怖片、情绪波动时）才会渴望依偎，可选择3分；例四：已养成"每日睡前拥抱"或类似安抚性仪式，可选择4分。
			</p>
		</div>
	</div>
	<!-- 37 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题从"缺失代价"角度评估感官吸引的"生理-心理必要性"。触觉剥夺实验表明，长期缺乏社交触碰会导致皮质醇升高、孤独感加剧。本题通过"缺乏触碰是否引发不适"量化感官吸引的"稳态调节功能"。高分者通常将触觉视为"基础情绪营养素"；低分者则触觉需求可被独处替代。在谱系中，感官吸引可作为"非性亲密替代方案"，本题为其"必需性"提供证据。
			</p>
			<p><strong>具体案例：</strong>例一：连续一周缺乏拥抱会明显出现情绪低落、失眠或易怒，可选择5分；例二：即使数月无人触碰也始终情绪平稳，可选择0分；例三：仅在生病或极度疲惫时才渴望身体接触，可选择3分；例四：已觉察"每周至少三次拥抱"有助于情绪稳定，可选择4分。
			</p>
		</div>
	</div>
	<!-- 38 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题测试"感官-性吸引分辨精度"，是防止"触碰误读"为性邀约的关键。研究发现，有性恋者常将任何亲密触碰解读为性信号，而无性恋者更易保持"触碰=安慰"的纯功能链。本题通过"主观区分信心"评估您的"触觉意图解码准确率"。高分者已建立"拥抱=安全港，性接触=生殖器刺激"的决策树；低分者则常担心"抱太久会不会被误会"。
			</p>
			<p><strong>具体案例：</strong>例一：能清晰分辨"想拥抱朋友"只是寻求安慰，而"想抚触伴侣"伴随性唤起，可选择5分；例二：几乎所有触碰都会担心被误解为性暗示，可选择0分；例三：需通过"触碰部位"来辅助判断动机，可选择3分；例四：已习惯将"非生殖器触碰"自动归入感官或情感范畴，可选择4分。
			</p>
		</div>
	</div>
	<!-- 39 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题考察感官吸引的"关系普适性"，测试其是否超越浪漫对象，扩展至友情/亲情。触觉社会学表明，文化与关系类型共同塑造触碰规范。本题通过"是否对非浪漫对象也有触觉需求"量化感官吸引的"社交泛化度"。高分者通常将触碰视为"通用安慰语言"；低分者则触觉需求高度"伴侣绑定"。
			</p>
			<p><strong>具体案例：</strong>例一：您能自然地在多种关系中表达身体亲近的需求——无论是父母、朋友还是宠物，都渴望拥抱与接触，把触觉视作情感联结的重要渠道，可选择5分；例二：触觉需求仅在浪漫或伴侣关系中出现，认为拥抱主要属于亲密关系的专属行为，可选择0分；例三：触觉渴望局限于特定性别或气质类型的人身上，通常带有选择性或安全边界考量，可选择3分；例四：虽然能通过抱枕、毛毯等物理替代满足部分安抚感，但内心仍渴望真实的人际触碰与温度，可选择4分。
			</p>
		</div>
	</div>
	<!-- 40 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题评估"感官需求的表达主动性"，将内在渴望转化为社交行动。沟通研究表明，明确表达触觉需求能显著提升关系满意度。本题通过"是否主动请求非性触碰"量化您的"触觉沟通能力"。高分者已将"抱我一下"纳入日常语言；低分者则常"憋着"或依赖对方主动。
			</p>
			<p><strong>具体案例：</strong>例一：当情绪低落或压力过大时，您能直接表达身体安慰的需求，对朋友坦然说出"能抱我一下吗"，并认为这种触碰是情感支持的一部分，可选择 5
				分；例二：无论多么需要安慰，也习惯把感受压抑在心里，宁愿独自忍受不适而不求助，可选择 0
				分；例三：只有在对方先表现出亲近或询问时，才会顺势提出"其实我也需要拥抱"，表达依赖仍需外界引导，可选择 3
				分；例四：已开始尝试用非语言信号（如靠近、眼神、肢体姿态）传达触觉需求，在逐步练习主动表达，可选择 4 分。</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题作为"身份觉察"的起点，评估您对自身吸引模式与"社会默认脚本"（性吸引+浪漫吸引=完整人性）的偏差感知程度。社会比较理论（Festinger,
				1954）指出，觉察差异是身份形成的先决条件。本题通过"主观差异感强度"量化您的"谱系觉醒阶段"。高分者通常已完成"从困惑到命名"的跃迁；低分者则仍处于"隐形默认"状态。本题为后续"是否需外部验证"提供依据。
			</p>
			<p><strong>具体案例：</strong>例一：您常在社交场合或恋爱话题中产生困惑——"为什么别人能一见钟情，而我只感受到友情？"这种反复的自我对比让您开始怀疑自身的吸引机制，可选择 5
				分；例二：从未对自己与他人的情感模式差异产生疑问，认为所有人的体验大致相同，可选择 0 分；例三：仅在特定情境（如听到性笑话或恋爱谈资）时短暂察觉自己反应不同，但很快带过，可选择 3
				分；例四：已开始主动在网络上搜索"无性恋"或相关概念，希望理解这种差异的根源，可选择 4 分。</p>
		</div>
	</div>
	<!-- 42 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题评估"身份接纳度"，这是心理健康的关键预测变量。少数群体压力模型（Meyer,
				2003）表明，内部污名化会导致焦虑/抑郁。本题通过"接纳连续体"量化您的"自我和谐程度"。高分者已将谱系身份转化为"独特优势"；低分者则可能陷入"修复幻想"。本题为"是否需接纳干预"提供靶点。
			</p>
			<p><strong>具体案例：</strong>例一：您不仅接受，还真诚地为自己的无性恋身份感到骄傲，将其视为一种更纯粹、更本质的情感联结方式，可选择 5
				分；例二：内心仍存矛盾，偶尔暗自希望"哪天能变得正常一点"，对身份抱有羞耻或否认情绪，可选择 0
				分；例三：意识到自己与多数人不同，但并未投入太多情感能量去思考或认同，仅以"这就是我"的态度淡然接受，可选择 3
				分；例四：已完成身份认知与外部沟通的平衡，主动向亲友出柜并在日常中自然表达，可选择 4 分。</p>
		</div>
	</div>
	<!-- 43 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题评估"知识获取主动性"，这是从"觉察"到"赋权"的桥梁。信息寻求行为研究表明，主动学习能显著提升自我效能感。本题通过"是否主动接触谱系资源"量化您的"身份探索深度"。高分者通常已形成"个人知识库"；低分者则信息匮乏。本题为"是否推荐资源"提供依据。
			</p>
			<p><strong>具体案例：</strong>例一：您不仅阅读过《The Invisible Orientation》，还主动关注 AVEN、Reddit asexuality
				板块或国内无性恋社群，能熟练区分"无浪漫""无性""半性"等概念，并以此反思自身经验，可选择 5 分；例二：从未主动检索相关信息，也不了解"无性恋"一词的确切含义，可选择 0
				分；例三：曾在网络上短暂浏览过相关话题，但未深入理解，仅停留在模糊印象阶段，可选择 3 分；例四：已加入微信无性恋群、豆瓣或Discord社区，偶尔参与讨论并分享观点，可选择 4 分。
			</p>
		</div>
	</div>
	<!-- 44 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题评估"身份披露行为"，是关系健康的关键。沟通理论（Gottman,
				1999）指出，元沟通能减少误解。本题通过"是否主动说明边界"量化您的"关系透明度"。高分者已将谱系身份融入关系契约；低分者则常"隐身"导致冲突。</p>
			<p><strong>具体案例：</strong>例一：恋爱初期即主动说明"我不体验性吸引，但渴望情感深度连接"，可选择 5 分；例二：从不提及相关身份，担心被误解或拒绝，可选择 0
				分；例三：仅在关系冲突或被质疑时被动解释，可选择 3 分；例四：已准备"个人身份说明书"或自我介绍文本，以便未来沟通，可选择 4 分。</p>
		</div>
	</div>
	<!-- 45 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题评估“知识→认知提升”的闭环效果，验证谱系教育的实际效用。叙事疗法表明，“重新命名经历”能重塑自我故事。本题通过“主观改善感”量化“身份叙事重构程度”。高分者已从“缺陷”叙事转向“多样性”叙事；低分者则知识未内化。
			</p>
			<p><strong>具体案例：</strong>例一：学习“灰性恋”后终于理解“为什么我偶尔有但不强烈”，感到如释重负，可选择 5 分；例二：阅读大量资料后仍觉得自己“是不是有病”，可选择 1
				分；例三：了解相关名词但生活未受影响，可选择 3 分；例四：已使用谱系化语言重新书写个人经历或自传，可选择 4 分。</p>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题针对流动无性恋（Aceflux）的核心特征：吸引的动态波动。流动无性恋者体验到性吸引的强度和频率不是固定不变的，而是像潮汐一样起伏——有时完全接近无性恋状态，对性毫无概念和兴趣；有时则向灰性恋倾斜，出现微弱或短暂的吸引。这种波动可能受激素周期、压力水平、季节变化或生活事件影响，呈现出明显的非线性态。通过此题，我们量化波动幅度以识别流动模式。该题考虑具体触发因素，以提供模式细节。
			</p>
			<p><strong>具体案例：</strong>例一：回顾过去一年，您可能连续数月对性毫无概念与兴趣，却在某个情绪高涨的周末，对一位老朋友产生短暂性幻想，随后又回归平静，可选择 5
				分；例二：性吸引强度始终稳定，如持续保持中等水平、无明显波动，可选择 0 分；例三：季节变化导致轻微起伏，可选择 3 分；例四：月经周期对吸引强度有明显影响，可选择 4 分。</p>
		</div>
	</div>
	<!-- 47 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题针对突发无性恋（Acespike）的特征：间歇性、短暂而强烈的性吸引体验。突发无性恋者平时可能对性完全无感；但偶尔，会突然经历一种强烈的性吸引，这种感觉来得猛烈、不可预测，往往伴随生理或心理的高峰，但很快就会消退，通常只持续几分钟到几小时，甚至不到一天，就完全消失无踪。这种体验与流动无性恋的渐变波动不同，它更像是峰值爆发，比如在疲惫的一天结束时突然对路人产生强烈冲动，但醒来后一切如常。请回想您的经历：是否有过这种"闪击式"的吸引？这是一种谱系变体，它让生活偶尔点缀，却不打乱整体节奏。通过此题，我们隔离峰值事件以识别突发模式。该题评估持续时间和预测性，以细化特征。
			</p>
			<p><strong>具体案例：</strong>例一：您平时对性毫无兴趣，却曾在咖啡店突然对陌生人产生强烈冲动，心跳加速、脑海闪现亲密画面，但数小时后便完全消失，仿佛从未发生，可选择5分；例二：在会议或公共场合突发吸引、随后快速消退，可选择4分；例三：偶尔出现短暂冲动、持续时间较短，可选择3分；例四：吸引多为缓慢积累或持久存在，无"爆燃即灭"模式，可选择0分。
			</p>
		</div>
	</div>
	<!-- 48 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题用于识别触发性恋（Apressexual）：性吸引依赖多种吸引类型的交互，而非单一情感深度。触发性恋者不会孤立地体验性吸引，它总是需要其他吸引类型作为"铺垫"或"触发器"，比如只有当您同时感受到强烈的浪漫心动和情感信任时，性吸引才会像火花一样被点燃。这扩展了半性恋的概念，后者更强调单一情感深度，而触发性恋则突出多种吸引的复杂互动机制。例如浪漫的甜蜜+情感的深度+审美的欣赏共同激发性欲。请仔细思考：您的性吸引是否总需这种"多重铺垫"？这种模式在谱系中很常见，它反映了吸引的层层嵌套，让您的体验更像多维结构。通过此题，我们评估交互机制，以识别触发依赖。
			</p>
			<p><strong>具体案例：</strong>例一：您只有在对某人同时产生浪漫幻想（如想一起旅行）、建立情感信任（如分享秘密）并欣赏TA外貌时才会出现性欲，可选择5分；例二：主要由浪漫与情感共同触发，可选择4分；例三：仅由外貌或审美触发，可选择3分；例四：性吸引可单独出现，无需情感或信任前提，可选择1分。
			</p>
		</div>
	</div>
	<!-- 49 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题探讨磨损性恋（Fraysexual）的模式：吸引随亲密度增加而减少。磨损性恋者往往对陌生人或关系还处于表层阶段的对象更容易产生性吸引，那种神秘感和距离感激发想象和冲动；但随着关系的发展、情感联结的加深，这种性吸引反而会逐渐减弱或完全消失。这与半性恋的模式完全相反，后者需要在深度后才出现吸引，而磨损性恋则在"浅尝"时最强烈。请回想您的关系动态：是否有过初遇时火热、但越亲近越冷却的经历？这是一种独特的谱系视角，它提醒我们吸引可以是转瞬即逝的，而非永恒的。通过此题，我们测量亲密度与吸引强度的负相关，以识别反向模式。该题评估关系阶段变化，以细化动态。
			</p>
			<p><strong>具体案例：</strong>例一：您初次见到某人时会对TA产生强烈性幻想和冲动，但相处几周后当TA成为朋友时，这种感觉完全淡去甚至消失，可选择5分；例二：初遇时有冲动但随时间逐渐冷却，可选择4分；例三：仅在浅层关系中频繁出现性吸引，可选择3分；例四：关系越深入性吸引越强，可选择0分。
			</p>
		</div>
	</div>
	<!-- 50 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题针对单向性恋（Lithosexual /
				Akiosexual）：偏好单向吸引，避免互惠。单向性恋者能够对他人产生性吸引，这种感觉在幻想中安全；但当这种吸引得到对方的回应，或者关系有发展成双向互动的可能时，反而会引发不适、焦虑或兴趣的突然丧失。您倾向于维持吸引的单向性质，不愿让它变成现实的互惠，因为那可能会打破幻想的纯净或带来压力。请反思：当对方"回应"您的吸引时，是否让一切冷却？这反映了互动方式的独特偏好，在谱系中，它允许您享受单恋的美，而避开双向的复杂。通过此题，我们评估回应敏感性，以识别单向偏好。该题聚焦不适类型，以提供洞察。
			</p>
			<p><strong>具体案例：</strong>例一：您在脑海中对某人产生强烈性幻想，觉得那很美好，但当TA表现出兴趣并想进一步发展时，您反而退缩或瞬间失去兴趣，可选择5分；例二：在对方回应后感到轻微不适或疏离，可选择4分；例三：仅偶尔在互动升级后兴趣下降，可选择3分；例四：对方回应越积极，您的吸引越强，可选择0分。
			</p>
		</div>
	</div>
	<!-- 51 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题用于判断回应性恋（Reciprosexual）：吸引依赖互惠信号。回应性恋者不会主动或独立产生性吸引，它需要一个“镜像”机制：只有当您明确感知到对方对您存在性吸引时，比如通过眼神、言语或行为示好，您才会对该对象产生相应的性吸引。这强调了社会互动在吸引形成中的关键作用，就像一场舞蹈，需要对方的先一步才能跟上。请思考：您的性冲动是否总是需对方“先点燃”？这是一种高度互动的谱系类型，它让吸引成为一种共享的，而非独奏。通过此题，我们评估镜像依赖，以识别互惠模式。该题考虑感知准确性，以细化条件。
			</p>
			<p><strong>具体案例：</strong>例一：您平时对某人无性兴趣，但当TA明确示好、表达对您的欲望时，您突然也对TA产生强烈性吸引，可选择5分；例二：仅在对方以眼神或肢体语言示好时被触发，可选择4分；例三：需对方以言语确认或赞美您才产生吸引，可选择3分；例四：您的性吸引始终独立存在，不依赖他人回应，可选择2分。
			</p>
		</div>
	</div>
	<!-- 52 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题针对接受性恋（Accipiosexual /
				Iamvanosexual）：被动接受偏好。接受性恋者在性互动中更倾向于扮演接收者的角色，您愿意接受来自他人的性行为或性表达，比如享受伴侣的主动和引导，但缺乏主动发起或主导的意愿。这不是被动消极，而是享受被引导的舒适感。请回想：您是否更享受被爱和被触碰的过程，而非自己规划和推动？这区分了互动中的角色倾向，在谱系中，它允许您在关系中找到平衡的舒适区。通过此题，我们评估角色偏好，以识别被动模式。该题聚焦意愿差异，以梳理倾向。
			</p>
			<p><strong>具体案例：</strong>例一：在亲密时刻，您更喜欢由伴侣主导一切，自己被动接受并从中获得愉悦，可选择5分；例二：在伴侣的引导下逐渐投入并回应，可选择4分；例三：与伴侣轮流主导、角色灵活切换，可选择3分；例四：您偏好主动发起、掌控节奏，可选择0分。
			</p>
		</div>
	</div>
	<!-- 53 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题用于识别给予性恋（Placiosexual）：主动给予偏好。给予性恋者在性互动中更倾向于扮演提供者的角色，您愿意为他人带来性愉悦或参与活动，比如专注于伴侣的满足和快乐，但不特别期望或不愿意自己成为被动接受的一方。这往往源于利他主义或情感满足感。请反思：您的参与是否更多是为对方的快乐和连接感，而非追求自身的生理高潮？这与接受性恋互补，提供完整互动谱系的另一面。通过此题，我们评估给予动机，以识别利他模式。该题考虑满足来源，以细化偏好。
			</p>
			<p><strong>具体案例：</strong>例一：您在亲密时更享受取悦伴侣、看到TA满足的表情，而对自己的生理满足并不在意，可选择5分；例二：主要关注对方的快乐，同时偶尔留意自身感受，可选择4分；例三：更在意情感连接与互动氛围，而非单方满足，可选择3分；例四：更注重自身的满足或追求平衡给予，可选择0分。
			</p>
		</div>
	</div>
	<!-- 54 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题针对厌性恋（Apothisexual）：对行为的稳定反感。厌性恋者对性行为本身存在一种深刻的、稳定的厌恶或回避情绪，这种感觉是本能的，即使偶尔有性吸引，也会让您明确拒绝任何形式的参与。它独立于吸引强度，聚焦于行为的态度——一想到实际的性互动，就感到不适或完全排斥。请态度评估：厌恶是否绝对？这种态度在谱系中很常见，它保护您的边界，让您专注于其他形式的亲密。通过此题，我们评估反感强度，以识别回避类型。该题区分吸引与行为，以观察独立性。
			</p>
			<p><strong>具体案例：</strong>例一：即使对某人有性吸引，您也无法想象或拒绝参与任何性行为，因为行为本身让您感到本能的回避，这非常符合5分；相反，如果您对行为持完全开放的态度，没有任何回避感，这则符合0分。例二：感到性吸引时仍有明显回避感则可选择4分。例三：对性行为偶尔感到不适或犹豫则可选择3分。例四：对性行为较为接受，仅持轻微保留态度，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 55 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题探讨不渴望关系性恋（Orchidsexual）：吸引与行为分离。不渴望关系性恋者能够清晰地体验到性吸引，比如对某人产生内在的性幻想或冲动，但同时强烈不希望将这种吸引转化为现实的性行为或建立性关系。这种内在体验与外在行动的脱节，因为现实的触碰可能会破坏幻想的纯净。请反思：您的欲求是否停留在脑海，而行动意愿完全缺失？这强调了吸引可以是私密的、内省的，而非必须外化的。通过此题，我们评估分离程度，以识别内在偏好。该题聚焦意愿差距，以提供洞察。
			</p>
			<p><strong>具体案例：</strong>例一：您偶尔会对某人产生性幻想，并感到兴奋，但从不考虑或希望实际发生任何事，这非常符合5分；相反，如果吸引总是推动您采取行动，这则符合0分。例二：幻想能够满足需求而无需实际行动则可选择4分。例三：幻想与行动偶尔分离则可选择3分。例四：幻想通常会转化为行动意愿，仅偶尔停留在幻想层面，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 56 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题用于判断渴望关系性恋（Cupiosexual）：行为欲求独立于吸引。渴望关系性恋者尽管缺乏典型的内在性吸引体验，比如没有那种本能的性冲动，但基于其他动机如寻求更深的情感亲密、满足好奇心、探索身体连接或社会期望，仍然主动渴望建立或参与性关系。这提供谱系的包容性，证明行为可以源于非性欲求，而非必须有内在火焰。请反思：您的行为欲求是否来自"想通过性加深连接"或"好奇尝试"，而非生理饥渴？这是一种探索形式，让谱系更完整。通过此题，我们评估非性动机，以识别行为驱动。该题列举动机，以促进分类。
			</p>
			<p><strong>具体案例：</strong>例一：您没有自发的性欲，但为了加深与伴侣的情感纽带或单纯好奇，想尝试性关系，这非常符合5分；相反，如果无任何行为欲求，这则符合0分。例二：主要出于增进亲密关系的动机则可选择4分。例三：主要出于好奇心想要探索则可选择3分。例四：有一定的行为意愿，但动机较弱，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 57 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题针对疑性恋（Quoisexual）：概念理解困难。疑性恋者对"性吸引"这一概念本身存在深刻的理解困难，不是因为缺乏体验，而是因为这个定义似乎无法贴合您的内在感受——您可能读了很多解释，却仍不确定自己是否曾经"真正"体验过它，或者这个概念是否根本不适用于描述您的世界。它像一个抽象的谜语，让您感到"别人在说什么，我听不懂"。请概念匹配：困惑度是否高？这反映认知层面的挑战，在谱系中，它邀请我们质疑定义本身。通过此题，我们评估理解障碍，以识别认知类型。该题鼓励概念测试，以澄清困惑。
			</p>
			<p><strong>具体案例：</strong>例一：即使反复阅读性吸引的定义，您仍不确定自己的感觉是否匹配，或者觉得这个词对您来说毫无意义，这非常符合5分；相反，如果您能清晰识别和描述自己的性吸引，这则符合0分。例二：需要具体示例才能澄清是否体验过则可选择4分。例三：部分定义与自身感觉匹配则可选择2分。例四：基本能够识别但偶尔存在模糊感，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 58 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题用于吸引模糊性恋（Idemsexual）：类型识别困难。吸引模糊性恋者难以区分自己所体验的各种"喜欢"——是性吸引、审美欣赏、情感连接，还是浪漫心动？这些感觉常常混杂在一起，难以分离成分。这扩展了基础边界的认知挑战，比如您可能觉得欣赏某人的美感时，总夹杂一丝情感温暖，无法判断是否有性元素。请反思：您的各种"喜欢"是否总是融合不清？这让您的吸引模式更像一幅印象派画作，模糊却真实。通过此题，我们评估混淆程度，以识别模糊模式。该题列举类型，以促进区分练习。
			</p>
			<p><strong>具体案例：</strong>例一：您常常将对某人的审美欣赏和情感连接混为一谈，无法单独挑出"性吸引"的部分，这非常符合5分；相反，如果您能清晰地将各种吸引分类，这则符合0分。例二：审美吸引与情感吸引经常混淆则可选择4分。例三：偶尔能够清晰区分但多数时候模糊则可选择2分。例四：基本能够区分各类吸引，仅偶尔混淆，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 59 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>本题针对感受模糊性恋（Desinosexual）：吸引的模糊质感。感受模糊性恋者无法体验到典型、明确的性吸引，只能感受到一种朦胧、难以定义的暖流或拉扯感，这种体验太模糊，无法判断它是否属于"性吸引"的范畴——它可能像一股轻柔的雾气，触手可及却抓不住形状。这深化了灰性恋的微弱体验，让您的吸引更像无定形。请反思：您的吸引是否总是朦胧、无法清晰贴上标签？通过此题，我们评估模糊程度，以识别质感类型。该题强调定义挑战，以梳理体验特征。
			</p>
			<p><strong>具体案例：</strong>例一：当您对某人产生感觉时，它总是模糊不清，您不确定这是审美、情感还是某种"性"的东西，但无法明确，这非常符合5分；相反，如果您的吸引总是明确可定义，这则符合0分。例二：感觉朦胧且在不同类型间拉扯则可选择4分。例三：偶尔能够清晰界定吸引类型则可选择2分。例四：多数时候吸引类型明确，仅偶尔模糊，则可选择1分。
			</p>
		</div>
	</div>
	<!-- 60 -->
	<div class="question">
		...
		<div class="explanation">
			<p><strong>本题用意：</strong>此题用于性学兴趣性恋（Bellussexual）：认知兴趣独立于体验。性学兴趣性恋者虽然不体验个人性的内在吸引或欲望，但对性相关话题保持浓厚的学术兴趣或好奇心，比如热爱阅读性历史、性心理学书籍、分析性文化现象，或参与性教育讨论，却完全没有将这些应用到自己的生活。这区分了情感与智力层面，像一位学者热衷探秘古籍，却无意亲身演绎。请反思：您对性学的热情是否纯学术、好奇，而无个人欲望？这让您成为知识的守护者，而非参与者。通过此题，我们评估兴趣类型，以识别认知分离。该题覆盖兴趣领域，以全面评估。
			</p>
			<p><strong>具体案例：</strong>例一：您能花几个小时阅读关于性多样性的书籍，并感到兴奋和满足，但这纯粹是智力好奇，没有转化为个人性欲，这非常符合5分；相反，如果对此类话题无任何兴趣，这则符合0分。例二：对性心理学书籍感兴趣但与个人欲望无关则可选择4分。例三：主要出于文化分析角度的好奇则可选择2分。例四：有一定兴趣但不强烈，则可选择1分。
			</p>
		</div>
	</div>
</div>
