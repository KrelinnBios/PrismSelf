...
<!-- 第一部分：内部体验与核心认同（1-12 题） -->
<div class="section">
    <h2>第一部分：内部体验与核心认同（1-12 题）</h2>
    ...
    <div class="question">
        ...
        <div class="explanation">
            <p><strong>本题用意：</strong>观察内在性别感与指派性别之间是否存在持续或反复出现的不一致。这里记录的是当前体验的强度和频率，不能仅凭单题判断任何身份。
            </p>
            <p><strong>具体案例：</strong>例一：若您出生指派为男性，但从小就觉得自己“应该是女孩”，并持续感到这种错位，则可选择 5 分；相反，若您从未质疑过指派性别，并觉得它完全符合内在，则可选择 0 分。例二：若您偶尔在梦中或幻想中觉得自己是异性，但醒来后无强烈不适，则可选择 2 分。例三：若您在青春期后越来越觉得指派性别“不对劲”，则为高分。
            </p>
            <p><strong>心理学视角：</strong>性别认同不一致感在 DSM-5 中被描述为性别焦虑的核心特征之一。研究发现，跨性别者通常报告这种不一致感出现在青春期前，平均年龄为 7-8 岁。然而，由于社会压力或缺乏相关认知，很多人直到成年才意识到这种不一致。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            <p><strong>本题用意：</strong>观察性别化称呼或归类是否会引发不适。重点是这种反应出现的频率、强度和具体情境，不把一般的称谓偏好直接解释为身份结论。</p>
            <p><strong>具体案例：</strong>例一：若每次被叫“先生”时都感到刺耳和不适，像穿错衣服，则可选择 5 分；相反，若您觉得这些称谓自然且舒适，则可选择 0 分。例二：若在正式场合偶尔觉得称谓别扭，但不持久，则可选择 2 分。例三：若在朋友圈被叫指派性别时内心抗拒，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            <p><strong>本题用意：</strong>观察想象另一种性别身份或表达方式时，是否会出现更舒适、更自在或更符合内心的感受。积极体验可以作为自我观察线索，但不单独决定身份。
            </p>
            <p><strong>具体案例：</strong>例一：若您想象以异性身份生活时感到巨大解脱和喜悦，则可选择 5 分；相反，若您觉得当前身份已足够真实，则可选择 0 分。例二：若您偶尔想想“如果我是异性也许更开心”，但不强烈，则可选择 2 分。例三：若您在虚拟游戏中选择异性角色时感到更自在，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您觉得“男/女”标签像紧身衣，无法容纳您的感受，则可选择 5 分；相反，若您完全认同其中之一，则可选择 0 分。例二：若您偶尔觉得二元标签不够用，但多数时候还行，则可选择 2 分。例三：若您在填写表格时总犹豫性别选项，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您小时候坚持穿异性衣服并说“我是女孩/男孩”，则可选择 5 分；相反，若童年完全顺应指派性别，则可选择 0 分。例二：若您偶尔偷偷试穿异性衣服，但不公开，则可选择 2 分。例三：若童年游戏中总选择异性角色，则为高分。
            </p>
            <p><strong>发展心理学视角：</strong>性别认同通常在 3-4 岁开始形成并稳定。跨性别儿童往往在这个年龄段就表现出明显的跨性别行为或表达。然而，许多儿童会因社会压力而压抑这些表达，直到青春期或成年后才重新浮现。
            </p>
    ...
    <div class="question">
        ...
        <select name="q7">
            ...
            <option value="5">5 - 几乎没有明显的性别感</option>
        </select>
        <div class="explanation">
            <p><strong>本题用意：</strong>观察性别概念在您的内在体验中是否重要、清晰或具有共鸣。高分只表示性别感较弱或疏离感较强，不要求采用“无性别”等标签。</p>
            <p><strong>具体案例：</strong>例一：若您觉得“性别”像外来标签，无内在共鸣，则可选择 5 分；相反，若您有强烈性别感，则可选择 0 分。例二：若您偶尔无视性别标签，但多数时候有感，则可选择 2 分。例三：若在讨论性别时总觉得“无关我事”，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您的性别感每周变化，一天男性一天女性，则可选择 5 分；相反，若终身稳定，则可选择 0 分。例二：若情绪低落时偶尔觉得无性别，则可选择 2 分。例三：若在不同环境中性别感切换，则为高分。
            </p>
            <p><strong>流动性模式：</strong>流动性别的变化可能有规律（如与月经周期、季节变化相关）或无规律。有些人可能在不同社会角色间切换（工作时 vs 家庭时），而另一些人可能纯粹随内在感受变化。记录这些模式有助于理解自己的流动性。
            </p>
    ...
    <div class="question">
        ...
        <select name="q9">
            ...
            <option value="4">4 - 大多是想成为对方</option>
            <option value="5">5 - 几乎完全是羡慕或想成为对方</option>
        </select>
        <div class="explanation">
            <p><strong>本题用意：</strong>区分想接近、欣赏或与对方建立关系的吸引，与希望拥有相似性别特征或被以相似方式看待的羡慕。两者也可能同时出现。</p>
            <p><strong>具体案例：</strong>例一：若看到异性时想“如果我是她该多好”，则可选择 5 分；相反，若想“想和她交往”，则可选择 0 分。例二：若两者混杂，则可选择 3 分。例三：若对明星的欣赏是羡慕身材而非想拥有，则为高分。
            </p>
            ...
            <div class="reflection-hint">
                <strong>深度反思提示：</strong>当您羡慕某人时，是羡慕其整体存在方式，还是特定特征（声音、姿态、社会待遇）？这种羡慕是否伴随着“如果我是对方，生活会更好”的想象？羡慕与吸引在您的情感体验中如何区分？
            </div>
        </div>
    </div>
    <!-- 10 -->
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若压力时总幻想自己是异性来放松，则可选择 5 分；相反，若无此习惯，则可选择 0 分。例二：若偶尔在小说中代入异性角色，则可选择 2 分。例三：若这是日常逃避方式，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您觉得性别像颜色渐变，则可选择 5 分；相反，若固定如黑白，则可选择 0 分。例二：若偶尔觉得介于二元，则可选择 2 分。例三：若在不同阶段性别感变化，则为高分。
            </p>
            ...
            <div class="reflection-hint">
                <strong>深度反思提示：</strong>如果您用 0-100 分给“男性化”和“女性化”打分，您的分数是多少？这两个分数相加是 100 分吗？如果您的性别是一个三维空间中的点，那个空间是什么样子的？
            </div>
        </div>
    </div>
    <!-- 12 -->
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若胸部/喉结生长时感到“不对劲”，则可选择 5 分；相反，若觉得正常，则可选择 0 分。例二：若偶尔讨厌变化，则可选择 2 分。例三：若变化导致抑郁，则为高分。
            </p>
...
<!-- 第二部分：身体与社会焦虑（13-24 题） -->
<div class="section">
    <h2>第二部分：身体与社会焦虑（13-24 题）</h2>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您讨厌胸部/喉结，觉得它“多余”，则可选择 5 分；相反，若您欣赏身体，则可选择 0 分。例二：若偶尔觉得体毛烦人，但不性别相关，则可选择 1 分。例三：若声音变化导致痛苦，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <select name="q14">
            ...
            <option value="3">3 - 有时</option>
            <option value="4">4 - 经常</option>
            <option value="5">5 - 几乎总是，且很难不这样做</option>
        </select>
        <div class="explanation">
            <p><strong>本题用意：</strong>观察您是否会通过调整衣着、体毛或身体轮廓来获得更舒适的性别表达，以及这种需要对日常行动有多大影响。</p>
            <p><strong>具体案例：</strong>例一：若您每天束胸才能出门，则可选择 5 分；相反，若无此需求，则可选择 0 分。例二：若偶尔穿宽松衣，则可选择 2 分。例三：若刮体毛是为了性别中性，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若被误认异性时内心窃喜，则可选择 5 分；相反，若觉得冒犯，则可选择 0 分。例二：若无感，则可选择 2 分。例三：若在网上被误认时开心，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若照镜子时总避开身体，则可选择 5 分；相反，若欣赏，则可选择 0 分。例二：若偶尔感到分离，则可选择 2 分。例三：若洗澡时闭眼，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若嫉妒异性声音，则可选择 5 分；相反，若无，则可选择 0 分。例二：若偶尔羡慕骨架，则可选择 2 分。例三：若看到异性身体时痛苦，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若想象未来以指派性别衰老时绝望，则可选择 5 分；相反，若期待，则可选择 0 分。例二：若偶尔觉得乏味，则可选择 2 分。例三：若无法想象结婚，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若游戏总选异性角色，且感到自在，则可选择 5 分；相反，若选指派性别，则可选择 0 分。例二：若偶尔试玩，则可选择 2 分。例三：若社交媒体用异性头像，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若希望去除所有性征，则可选择 5 分；相反，若喜欢二元特征，则可选择 0 分。例二：若偶尔想中性，则可选择 2 分。例三：若手术目标是中性，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若聚会时被期望“像男人/女人”行为感到压抑，则可选择 5 分；相反，若舒适，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若工作角色冲突，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            <p><strong>本题用意：</strong>观察您是否会向往某种性别群体的互动方式、社会待遇或归属感，并区分这种向往与对具体个人的吸引。</p>
            <p><strong>具体案例：</strong>例一：若羡慕女性朋友被叫“姐妹”，则可选择 5 分；相反，若无，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若看到异性社交时嫉妒，则为高分。</p>
            ...
            <div class="reflection-hint">
                <strong>深度反思提示：</strong>您羡慕的是他们的互动方式、社会待遇，还是群体归属感？如果可以安全地体验一天您向往的社交方式，您最想体验什么？这种羡慕是否让您回避某些社交场合？
            </div>
        </div>
    </div>
    <!-- 23 -->
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若医生说“女性身体”时内心否认，则可选择 5 分；相反，若接受，则可选择 0 分。例二：若偶尔不适，则可选择 2 分。例三：若体检时回避，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您因穿着中性而被同学嘲笑，可据频率选择 4 或 5 分；例二：若您因表达性别特质而被家人误解，可选 3 分；例三：若从未有过此类经历，选 0 分。</p>
...
<!-- 第三部分：表达与社会互动（25-33 题） -->
<div class="section">
    <h2>第三部分：表达与社会互动（25-33 题）</h2>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若穿异性衣服感到自信，则可选择 5 分；相反，若不喜欢，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若化妆/剃须感到愉悦，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若想选“女性职业”但不适，则可选择 5 分；相反，若无，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若兴趣被嘲笑，则为高分。</p>
            <p><strong>职业性别隔离：</strong>许多职业和兴趣仍存在强烈的性别刻板印象（如 STEM 领域男性多、护理领域女性多）。当个人兴趣与指派性别期望冲突时，可能产生不适感。这种不适可能源于外部压力，也可能源于内部认同与兴趣的不一致。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若在同性聚会中感到外人，则可选择 5 分；相反，若舒适，则可选择 0 分。例二：若偶尔，则可选择 1 分。例三：若话题不合，则为高分。</p>
            <p><strong>群体归属感：</strong>同性群体往往有共享的性别化经验和期待。当个人内在认同与指派性别不一致时，可能难以融入同性群体。这种疏离感可能是隐性的（“我不完全理解他们”），也可能是显性的（“我不想像他们一样”）。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若希望改证件为 X 性别，则可选择 5 分；相反，若无兴趣，则可选择 0 分。例二：若好奇，则可选择 2 分。例三：若计划申请，则为高分。</p>
            <p><strong>法律认同的重要性：</strong>法律性别标记是官方身份的核心部分。对于非二元者，X 性别或其他标记可以提供重要的法律确认。然而，在法律不承认非二元的国家，这种渴望可能带来挫败感。法律变更的难度也反映了社会接受程度。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您在网络游戏中总是使用女性角色并感到这才是自己，可选 5 分；例二：若您曾在日记中用新名字称呼自己并感到愉悦，可选 3 分；例三：若从未想过这样尝试，选 0 分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若觉得日常是演戏，则可选择 5 分；相反，若自然，则可选择 0 分。例二：若偶尔，则可选择 1 分。例三：若努力维持，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若觉得无性别世界完美，则可选择 5 分；相反，若无区别，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若向往，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您看到《丹麦女孩》时泣不成声，可选 5 分；例二：若您偶尔因某非二元角色的台词而心头一震，可选 3 分；例三：若完全无感，选 0 分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若觉得表达应流动，则可选择 5 分；相反，若固定，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若心情变表达变，则为高分。</p>
...
<div class="section">
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您已研究过激素替代疗法的副作用并咨询医生，可选 5 分；例二：若您偶尔浏览过跨性别手术的科普文章，可选 2 分；例三：从未关心，选 0 分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若已出柜，则可选择 5 分；相反，若从未，则可选择 0 分。例二：若隐晦，则可选择 2 分。例三：若讨论，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若觉得不合身，则可选择 5 分；相反，若合身，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若想脱掉，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您每天必须穿不符合性别的衣服上班，因此情绪低落，可选 4 或 5 分；例二：若您在家庭聚会时因不能做自己而感到胸闷，可选 3 分；例三：无此情况，选 0 分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若恐惧压抑，则可选择 5 分；相反，若不相关，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若失去朋友担忧，则为高分。</p>
            ...
            <p><strong>社会支持理论：</strong>社会支持是应对压力的缓冲器。如果缺乏支持，个体更可能经历心理困扰。寻找 LGBTQ+ 友好社群可以弥补家庭支持的缺失。</p>
            <div class="reflection-hint">
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若您每天纠结“我到底是谁”，则可选择 5 分；相反，若内心平静，则可选择 0 分。例二：若只在特定场合（如家庭聚会）感到矛盾，则可选择 2 分。例三：若挣扎导致失眠或焦虑，则为高分。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若急需确认，则可选择 5 分；相反，若随便，则可选择 0 分。例二：若不确定，则可选择 2 分。例三：若希望，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若深度参与，则可选择 5 分；相反，若不，则可选择 0 分。例二：若浏览，则可选择 2 分。例三：若活跃，则为高分。</p>
            <p><strong>社群参与：</strong>加入 LGBTQ+ 社群是探索性别的重要步骤。这些社群提供安全空间、榜样、信息和情感支持。参与程度反映了探索的投入和舒适度。对于许多人，第一次接触社群是转折点，提供了“可能的自我”的范例。
            </p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若极度担心，则可选择 5 分；相反，若不，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若影响职业，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若充满希望，则可选择 5 分；相反，若不，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若想象快乐，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若觉得是成长，则可选择 5 分；相反，若不，则可选择 0 分。例二：若偶尔，则可选择 2 分。例三：若探索带来自知，则为高分。</p>
    ...
    <div class="question">
        ...
        <div class="explanation">
            ...
            <p><strong>具体案例：</strong>例一：若强烈向往，则可选择 5 分；相反，若没有，则可选择 0 分。例二：若好奇，则可选择 2 分。例三：若计划，则为高分。</p>
...
function calculateResult() {
    ...
    // 通用解释块（保持不变）
    const generalTip = `<div class="insight-card"><h3>结果校准提示</h3><p>请把结果与长期体验和具体情境对照，不要只凭一两道题决定身份。</p><ul><li><strong>区分认同与表达：</strong>服装、发型、气质和角色偏好不必与性别认同完全一致。</li><li><strong>区分认同与吸引：</strong>想成为某种性别形象，与想接近、欣赏或和某人建立关系是不同体验，也可能同时出现。</li><li><strong>留意外部条件：</strong>安全感、家庭和同伴期待、现实接触机会以及近期压力，都可能影响作答。</li></ul><p class="result-data-note">若结果与实际感受不符，可以记录分歧最大的题目，在状态较稳定时重新作答；不需要服从量表给出的类型描述。</p></div>`;
    ...
    personalizedSuggestions += `<li class="resource-network-step">
      ...
      <div class="resource-network-content">
        ...
        <div class="resource-network-grid">
          ...
          <section class="resource-network-card">
            <h5>线上平台</h5>
            <ul><li>Reddit：r/trans、r/nonbinary</li><li>豆瓣小组：跨性别、非二元性别</li><li>微信公众号：同语Ⅲ、Cooer 无限漫游等</li></ul>
          </section>
          <section class="resource-network-card">
            <h5>求助热线</h5>
    ...
    const reflectionActions = [
        ...
        {
            title: '区分认同、表达与社会压力',
            text: '喜欢某种服装、气质或角色，不会自动决定性别认同；对社会规范感到受限，也不等于必须采用某个身份标签。把这些体验分开记录会更清楚。'
        },
        {
            title: '进行低风险、可逆的探索',
            text: '在安全且私密的环境中，可以尝试不同的称呼、名字、服装或表达方式，并记录舒适度变化。任何尝试都可以暂停、调整或不再继续。'
        },
        {
            title: '优先照顾安全与支持需要',
            text: '如果表达或公开身份可能影响居住、经济、人际或身体安全，请先保护自己。持续痛苦或明显影响生活时，可以寻找尊重性别多样性的专业支持。'
        },
        {
            title: '允许结论保持开放',
            text: `“${mainType}”只是对本次作答模式的概括，不是身份判定。可以在经历、环境或自我理解发生变化后重新作答，比较体验而不是追求固定分数。`
        }
    ];
