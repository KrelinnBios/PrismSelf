...
const sections = [
	{
		...
		questions: [
			...
			['想到与女性发生性行为时，我的整体感受更偏向期待或兴奋，而不是强烈抗拒或毫无感觉。', '这里看总体情绪基调，不要求你一定想行动。']
		]
	},
	{
		title: '第二部分：男性及男性气质相关性吸引（13-24 题）',
		desc: '评估男性身份、男性气质、男性化表达或男性相关身体与互动线索是否会触发你的性吸引。',
		questions: [
			['我曾对男性产生明确的性吸引：想与对方发生性行为或带有性意味的亲密接触。', '关注真实吸引，而不是“我应该喜欢男性”或社会默认。'],
			['我看到某些男性时，会自发出现带有性意味的幻想或画面。', '自发幻想比为了验证自己而强迫想象更有参考价值。'],
			['我会把男性视为可能产生性吸引或发展性关系的对象，而不仅是欣赏或好感。', '这题看男性是否进入你的性吸引范围。'],
	...
	},
	{
		...
		questions: [
			...
			['同一性别内部，不同身体性征或气质表达会让我产生非常不同的性吸引反应。', '高分说明你可能需要比男性、女性、非二元更细致的描述。'],
...
Object.assign(questionExamples, {
	1: '例一：你见到一位女性同事时，会自然想象与她接吻或发生带有性意味的触碰，并明确感到欲望，可选 4–5 分；例二：只对极少数女性偶尔有过类似冲动，可选 2–3 分；例三：即使很欣赏女性，也从未想与她们发生性接触，可选 0–1 分。',
	2: '例一：在街上、聚会或作品中看到某些女性时，性相关画面会不经刻意测试就自己出现，可选 4–5 分；例二：只在特定关系或少数时刻出现，可选 2–3 分；例三：只有为了验证取向而努力想象时才有画面，可选 0–1 分。',
	3: '例一：即使目前不准备约会，你仍会把某些女性自然地视为可能发生性关系的对象，可选 4–5 分；例二：只对非常特定的女性如此，可选 2–3 分；例三：女性只会进入朋友、偶像或审美欣赏范围，可选 0–1 分。',
	4: '例一：某些女性的身体线条、声音或女性化肢体语言会直接点燃性兴奋，可选 4–5 分；例二：需要暧昧互动配合才偶尔出现，可选 2–3 分；例三：你会觉得这些线索很好看，却没有性唤起或性接触冲动，可选 0–1 分。',
	5: '例一：想象与喜欢的女性建立关系时，性会自然成为你期待探索的一部分，可选 4–5 分；例二：是否想要性取决于关系深度或当时状态，可选 2–3 分；例三：你能想象约会、陪伴与承诺，却很难想象自己想和她发生性行为，可选 0–1 分。',
	6: '例一：过去几年中，你对不同女性反复出现过明确性吸引，而非只有一次例外，可选 4–5 分；例二：一年内只有少数几次或集中在一段关系中，可选 2–3 分；例三：多年里几乎找不到明确例子，可选 0–1 分。',
	7: '例一：某位女性靠近、调情或展现女性气质时，你会想以带有性意味的方式触碰她，可选 4–5 分；例二：只有在双方已经很亲密时偶尔出现，可选 2–3 分；例三：你只想拥抱、牵手或靠近取暖，没有性唤起，可选 0–1 分。',
	8: '例一：成熟、运动、中性或柔和等多种女性风格都可能让你产生性吸引，可选 4–5 分；例二：只有一两种很具体的女性类型会触发，可选 2–3 分；例三：没有哪类女性风格会进入你的性吸引范围，可选 0–1 分。',
	9: '例一：与有吸引力的女性接吻或更亲密触碰时，你会明确感到欲望被增强并想继续，可选 4–5 分；例二：有时像性吸引、有时只是亲密舒适，可选 2–3 分；例三：这些动作对你主要意味着温暖或感情，不带性意味，可选 0–1 分。',
	10: '例一：原本只是注意到某位女性，当她明确调情或表达性兴趣后，你的性吸引会被明显唤起，可选 4–5 分；例二：只在少数对象身上出现回应性吸引，可选 2–3 分；例三：对方的兴趣通常只让你感到被认可、紧张或有压力，可选 0–1 分。'
});

Object.assign(questionExamples, {
	11: '例一：你能欣赏女演员或朋友的外貌，却清楚知道自己是否真的想与她发生性接触，可选 4–5 分；例二：有时会把“她很美”误当成性吸引，可选 2–3 分；例三：你很难分清欣赏、羡慕与性欲望，可选 0–1 分。',
	12: '例一：想象与有吸引力的女性发生性行为时，整体感受是期待、兴奋或愿意靠近，可选 4–5 分；例二：既有好奇也有空白或犹豫，可选 2–3 分；例三：通常只有抗拒、压力或完全没有内在吸引，可选 0–1 分。',
	13: '例一：你曾对男性产生明确的性欲望，例如想接吻、抚摸或发生性行为，可选 4–5 分；例二：只对极少数男性或特定关系偶尔出现，可选 2–3 分；例三：即使认可或亲近男性，也没有想进行性接触的冲动，可选 0–1 分。',
	14: '例一：看到某些男性时，带有性意味的画面会自然出现，不需要先说服自己应该喜欢他，可选 4–5 分；例二：只在少数情境或对象身上出现，可选 2–3 分；例三：只有刻意做取向测试时才勉强想象，可选 0–1 分。',
	15: '例一：你会自然把某些男性纳入潜在性伴侣范围，即使现实中未必行动，可选 4–5 分；例二：只有非常具体的一类男性能进入范围，可选 2–3 分；例三：男性只会成为朋友、榜样或浪漫对象，性并不会进入想象，可选 0–1 分。',
	16: '例一：某些男性的体态、声音、气味或男性气质会直接引发性兴奋，可选 4–5 分；例二：需要对方回应或深度熟悉后才偶尔出现，可选 2–3 分；例三：这些线索只带来欣赏、紧张或安全感，没有性欲望，可选 0–1 分。',
	17: '例一：想象与喜欢的男性建立亲密关系时，性会自然成为你可能期待的一部分，可选 4–5 分；例二：只在关系很深或条件合适时才可能想要，可选 2–3 分；例三：你能想象恋爱与陪伴，却不想与他发生性接触，可选 0–1 分。',
	18: '例一：过去几年里，你曾多次对不同男性出现明确性吸引，可选 4–5 分；例二：出现次数很少或只集中在一个对象上，可选 2–3 分；例三：多年里几乎没有可确认的男性方向性吸引，可选 0–1 分。',
	19: '例一：某位男性靠近、调情或展现男性气质时，你会出现带有欲望的触碰冲动，可选 4–5 分；例二：只有在关系安全时偶尔出现，可选 2–3 分；例三：你想拥抱或依靠他，但触碰并不带性意味，可选 0–1 分。',
	20: '例一：温柔、硬朗、运动或文艺等多种男性风格都可能触发你的性吸引，可选 4–5 分；例二：只有一个很狭窄的男性模板有效，可选 2–3 分；例三：没有哪种男性表达会让你产生性欲望，可选 0–1 分。'
});

Object.assign(questionExamples, {
	21: '例一：与有吸引力的男性接吻或亲密触碰时，你会明确感到性欲被增强并想继续，可选 4–5 分；例二：有时带性意味、有时只是感官舒适，可选 2–3 分；例三：触碰主要意味着亲密与安心，不会引发性冲动，可选 0–1 分。',
	22: '例一：当某位男性明确表达暧昧或性兴趣后，你原本不明显的性吸引会被唤起，可选 4–5 分；例二：只对少数已经有好感的人如此，可选 2–3 分；例三：对方示好只让你觉得开心、紧张或有压力，不会产生性欲望，可选 0–1 分。',
	23: '例一：你能喜欢男演员的外形、认可能力或羡慕体态，同时清楚这些是否伴随性接触欲望，可选 4–5 分；例二：有时会把崇拜或想被认可混成吸引，可选 2–3 分；例三：很难区分欣赏男性与想和男性交往性接触，可选 0–1 分。',
	24: '例一：想象与有吸引力的男性发生性行为时，整体感受偏期待或兴奋，可选 4–5 分；例二：好奇、犹豫和空白同时存在，可选 2–3 分；例三：通常是抗拒、压力，或只能想象自己在配合社会期待，可选 0–1 分。',
	25: '例一：你曾对一位非二元或性别酷儿对象产生明确的性幻想与触碰欲望，可选 4–5 分；例二：只有一次或只在特定表达上出现，可选 2–3 分；例三：你能支持、欣赏或亲近非二元者，但从未产生性吸引，可选 0–1 分。',
	26: '例一：某人的中性穿搭、混合气质或双性化表达本身会引发你的性兴奋，可选 4–5 分；例二：只有某些特定组合偶尔有效，可选 2–3 分；例三：你觉得这种表达很美或很酷，却没有性欲望，可选 0–1 分。',
	27: '例一：你会自然把某些非二元或中性表达对象视为潜在性伴侣，而不只是朋友或审美对象，可选 4–5 分；例二：只有极少数具体对象会进入范围，可选 2–3 分；例三：这类对象不会进入你的性关系想象，可选 0–1 分。',
	28: '例一：你先被某人吸引，后来得知对方不是男性或女性时，原有性吸引仍然存在，可选 4–5 分；例二：会明显动摇但不一定消失，可选 2–3 分；例三：一旦无法把对方归入预期性别，性吸引通常中断，可选 0–1 分。',
	29: '例一：中性声音、混合身体线索或不易二分的姿态会直接点燃性欲望，可选 4–5 分；例二：需要暧昧互动或特定对象配合才出现，可选 2–3 分；例三：这些线索只带来好奇或审美欣赏，可选 0–1 分。',
	30: '例一：过去几年里，你不止一次被不同的非二元、中性或混合表达对象性吸引，可选 4–5 分；例二：只有一两次明确经历，可选 2–3 分；例三：没有可回忆的例子，且不只是因为现实中从未接触，可选 0–1 分。'
});

Object.assign(questionExamples, {
	31: '例一：在知道某人的性别认同之前，你已经因对方的气质、动作或互动产生明确性吸引，可选 4–5 分；例二：有时可以先吸引、之后仍想确认性别，可选 2–3 分；例三：必须先确认对方属于某个性别，吸引才可能继续，可选 0–1 分。',
	32: '例一：一位非二元或中性表达对象向你明确调情后，你会出现相应的性兴奋与靠近冲动，可选 4–5 分；例二：只对少数已经熟悉的人如此，可选 2–3 分；例三：对方的兴趣只让你感到被喜欢或不知所措，不会唤起性吸引，可选 0–1 分。',
	33: '例一：与有吸引力的非二元对象接吻或亲密触碰时，你会明确感到性意味并想继续，可选 4–5 分；例二：有时是性欲、有时只是拥抱的舒适，可选 2–3 分；例三：亲密触碰对你可以很温暖，却不会转成性冲动，可选 0–1 分。',
	34: '例一：你可能先被某人的声音、表情或互动吸引，完全不需要先判断对方是男性还是女性，可选 4–5 分；例二：偶尔如此，但多数时候仍会先分类，可选 2–3 分；例三：性别类别是你判断性吸引能否发生的必要前提，可选 0–1 分。',
	35: '例一：你可以积极支持非二元权益、欣赏中性风格，同时准确判断自己是否真的想和某位对象发生性接触，可选 4–5 分；例二：两种感受有时会混在一起，可选 2–3 分；例三：常把价值认同或审美喜欢直接当成性吸引证据，可选 0–1 分。',
	36: '例一：想象与有吸引力的非二元或混合表达对象发生性行为时，整体感受偏期待与兴奋，可选 4–5 分；例二：好奇和犹豫并存，可选 2–3 分；例三：通常只有抗拒、空白，或完全无法把性放进想象，可选 0–1 分。',
	37: '例一：即使对方身份符合你的取向，某些身体性征也会明显增强或削弱你的性吸引，可选 4–5 分；例二：身体线索有影响但不是决定性条件，可选 2–3 分；例三：身体性征很少影响吸引是否出现，可选 0–1 分。',
	38: '例一：同一个人改变性别表达后，你的性吸引会随其女性化、男性化或中性气质明显变化，可选 4–5 分；例二：只对部分表达敏感，可选 2–3 分；例三：气质变化几乎不影响你对这个人的性吸引，可选 0–1 分。',
	39: '例一：某人的低沉声音、气味、走路姿态或说话动作会比身份标签更快触发你的性欲望，可选 4–5 分；例二：只有在整体氛围合适时偶尔有效，可选 2–3 分；例三：这些细节不会单独引发性吸引，可选 0–1 分。',
	40: '例一：同为男性、女性或非二元者，不同身体与气质表达会让你从强烈吸引变成完全无感，可选 4–5 分；例二：有差异但范围不大，可选 2–3 分；例三：只要性别方向符合，具体表达通常不太影响吸引，可选 0–1 分。'
});

Object.assign(questionExamples, {
	41: '例一：你常常是先被某人的幽默、互动张力和相处感受吸引，后来才注意到性别，可选 4–5 分；例二：性别与个体互动同样重要，可选 2–3 分；例三：只有先符合特定性别类别，个体魅力才可能继续起作用，可选 0–1 分。',
	42: '例一：即使某人的性别标签完全符合你的取向，身体、声音或互动方式不对时，你仍然不会产生性吸引，可选 4–5 分；例二：具体线索会影响强弱但不决定有无，可选 2–3 分；例三：标签符合时通常就足以进入吸引范围，可选 0–1 分。',
	43: '例一：你原以为自己不会被某类性别吸引，却因某人的气质、身体或互动被明确点燃性欲望，可选 4–5 分；例二：只发生过少数模糊例外，可选 2–3 分；例三：标签不在预期范围时，再合适的具体线索也不会触发，可选 0–1 分。',
	44: '例一：你常先出现身体兴奋、性幻想或想触碰的冲动，之后才意识到对方是什么身份，可选 4–5 分；例二：身体反应与身份判断几乎同时发生，可选 2–3 分；例三：你通常先完成性别分类，再决定自己能否被吸引，可选 0–1 分。',
	45: '例一：因为家人、同伴或社群期待，你曾把真实吸引解释成“只是欣赏”或强迫自己喜欢另一类人，可选 4–5 分；例二：只在公开表达时会修正说法，可选 2–3 分；例三：外界期待很少改变你对内在吸引的判断，可选 0–1 分。',
	46: '例一：你曾因“这个性别才是我应该喜欢的”而反复检查、放大或否认自己的感受，可选 4–5 分；例二：偶尔会受脚本影响但能重新分辨，可选 2–3 分；例三：你通常不会用应该不应该替代真实吸引证据，可选 0–1 分。',
	47: '例一：对某类对象产生性冲动后，你会因羞耻或害怕后果而立即压下、否认，甚至回避相关对象，可选 4–5 分；例二：只在不安全环境中会压抑，可选 2–3 分；例三：你很少因内化偏见否认已经出现的吸引，可选 0–1 分。',
	48: '例一：想象没有家庭、宗教、同伴评价与安全代价时，你会立刻更清楚自己真正想靠近谁，可选 4–5 分；例二：会清楚一些但仍有疑问，可选 2–3 分；例三：去除外部评价后，你对吸引方向的判断基本没有变化，可选 0–1 分。',
	49: '例一：你没有和某类人发生过性行为，但仍能根据自发幻想与欲望判断自己会不会被该类人吸引，可选 4–5 分；例二：仍会把经历当成重要证明，可选 2–3 分；例三：你认为没有实践就完全不能知道取向，可选 0–1 分。',
	50: '例一：你能欣赏或使用某类幻想题材，同时知道现实中并不想与相同对象发生性关系，可选 4–5 分；例二：有时能区分、有时会直接套用，可选 2–3 分；例三：你通常把幻想出现过什么直接当成现实取向结论，可选 0–1 分。'
});

Object.assign(questionExamples, {
	51: '例一：你会想和某人约会、成为彼此特别的人，却不想进行任何性接触，并能清楚区分两者，可选 4–5 分；例二：心动与性欲常一起出现、偶尔难分，可选 2–3 分；例三：只要想恋爱就默认等于有性吸引，可选 0–1 分。',
	52: '例一：你可以长时间欣赏某人的脸、穿搭或气质，却明确没有想接吻或发生性行为的冲动，可选 4–5 分；例二：欣赏有时会转成欲望，可选 2–3 分；例三：只要觉得好看就会直接判定为性吸引，可选 0–1 分。',
	53: '例一：你会很想与朋友拥抱、依偎或牵手来获得安心，同时清楚这不带性唤起，可选 4–5 分；例二：部分触碰是感官亲密、部分会变成性欲，可选 2–3 分；例三：你很难区分想贴近身体与想发生性接触，可选 0–1 分。',
	54: '例一：无论面对女性、男性或非二元对象，你都很少出现指向对方的自发性欲望，几年里也几乎没有明确例子，可选 4–5 分；例二：偶尔、微弱地出现过，可选 2–3 分；例三：性吸引是较常规且容易识别的体验，可选 0–1 分。',
	55: '例一：你会觉得很多人漂亮、有魅力，甚至愿意长时间欣赏，但这些感受通常停在观看与赞叹，不会转成性接触欲望，可选 4–5 分；例二：只有少数欣赏会转成欲望，可选 2–3 分；例三：审美吸引常自然伴随性欲，可选 0–1 分。',
	56: '例一：你的性吸引可能一年只出现几次、很快消退，或必须满足非常特殊的氛围与对象条件，可选 4–5 分；例二：频率比多数人少但并非罕见，可选 2–3 分；例三：性吸引通常稳定、频繁且不依赖特殊条件，可选 0–1 分。',
	57: '例一：外貌再符合偏好，如果没有长期信任与深度情感连接，你也不会产生性吸引；连接建立后才可能出现，可选 4–5 分；例二：情感连接会增强但不是必要条件，可选 2–3 分；例三：你常在尚未熟悉对方时就能产生明确性吸引，可选 0–1 分。',
	58: '例一：你可能几年只被一两个人性吸引，但每次出现时身体反应、幻想和触碰欲望都很明确，可选 4–5 分；例二：低频且信号仍有些模糊，可选 2–3 分；例三：你的吸引要么频繁，要么即使出现也难以确认，可选 0–1 分。',
	59: '例一：判断吸引时，你会稳定参考自发幻想、性唤起、想进行性接触和关系脚本，而不是只凭经历或标签，可选 4–5 分；例二：有几条标准但容易随焦虑改变，可选 2–3 分；例三：常需要外界定义或单一事件替你决定，可选 0–1 分。',
	60: '例一：即使结果给出某个倾向，你也会把它当成整理经验的地图，未来有新体验时允许调整，可选 4–5 分；例二：希望有结论但也能保留例外，可选 2–3 分；例三：更希望测试一次性证明身份，此后所有经历都必须服从标签，可选 0–1 分。'
});
...
function getQuestionFocus(questionNumber) {
	...
	if ([2, 14].includes(questionNumber)) return '这里把自发幻想作为线索。自发幻想通常比刻意测试、为了证明自己而强迫想象，更能反映吸引方向。若某类对象只在你努力想象“自己应该喜欢对方”时出现，而平时没有自然浮现，分数应更保守。';
	...
	if ([8, 20].includes(questionNumber)) return '这里不是要求你对所有类型都平均有吸引，而是看吸引是否只依赖一个非常狭窄的模板。若你会被多种女性或男性风格吸引，说明该方向较稳定；若只对极少数高度特定类型有效，可以给中低分。';
	...
	if ([58, 59, 60].includes(questionNumber)) return '这一组帮助整合结果。低频但明确的吸引、稳定的证据标准和开放的标签态度，都会影响结果呈现方式。你可以使用“主要、也会、很少、需要条件、暂时不确定”等描述，而不是强迫自己立刻固定身份。';
