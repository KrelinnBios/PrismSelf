(function () {
  ...
  const dimensions = [
    {
      ...
      reflection: '对您而言，信任是兴趣出现的前提、增强条件，还是与兴趣彼此独立？',
      ...
      questions: [
        ...
        ['当对方准确记得我的偏好、边界或小习惯时，我会感到明显的亲密吸引力。', '观察被看见和被记住是否会增强兴趣。', '例如对方记得我喜欢怎样的距离、称呼或安抚方式，这种细节比强烈刺激更打动我。'],
        ['结束后的陪伴与情感确认，会影响我是否期待整个亲密情境。', '观察互动后的联结是否是整体兴趣的一部分。', '例如想到结束后可以拥抱、聊天或收到确认，会让我更愿意想象前面的互动。']
      ]
    },
    {
      ...
      questions: [
        ...
        ['特定材质、温度或触感本身就能成为我感兴趣的主题。', '观察感官线索是否能独立带来审美或身体层面的兴趣。', '例如丝绸、皮革、柔软织物、凉感金属或温热触感中的某一种，会让我特别想继续想象。'],
        ['我喜欢亲密互动有清楚的准备过程，而不是毫无过渡地开始。', '观察仪式感和渐进转换是否增强兴趣。', '例如整理空间、洗浴、换衣或播放固定音乐，会帮助我从日常状态进入想象情境。'],
        ['节奏缓慢、留有停顿和逐渐升高的期待感，对我很有吸引力。', '观察渐进节奏与即时刺激之间的偏好。', '例如比起立刻进入强烈内容，我更喜欢先通过靠近、等待和细小变化累积张力。'],
        ['服装、妆容、配色或整体视觉风格会显著增强某个情境的吸引力。', '观察视觉审美是否是偏好的一部分。', '例如同一角色或情节在符合您审美的服装与配色下，会比普通日常状态更吸引您。'],
    ...
    },
    {
      ...
      reflection: '您的好奇通常停留在了解、幻想、讨论、低强度尝试，还是愿意持续实践？',
      ...
      questions: [
        ...
        ['我喜欢和可信任的人交换“也许可以探索”的想法，而不要求立刻行动。', '观察开放讨论本身是否带来连接和兴趣。', '例如一起列出好奇清单并允许任何一项最后不实践，这个讨论过程本身就让我觉得有吸引力。']
      ]
    },
    {
      ...
      reflection: '您被吸引的是身份、情节、语言、服装、仪式，还是暂时离开日常自我的感觉？',
      suggestions: ['事前区分角色内语言与现实评价，约定如何暂停和退出角色。', '容易触及身份敏感点的情节，应单独列出禁区与结束后的去角色方式。'],
      questions: [
        ['进入一个明确的虚构身份，会让我更容易对亲密情境产生兴趣。', '观察角色距离是否帮助表达平时不容易表达的兴趣。', '例如使用一个虚构职业、关系或人格设定后，我会比直接以日常身份互动更放松或投入。'],
    ...
    },
    {
      ...
      reflection: '您喜欢的是做决定、看到回应、承担照顾、拥有仪式性权力，还是其中某几项？',
      suggestions: ['把“可以决定什么”写成具体范围，并保留对方无需解释即可暂停的方式。', '主导方也需要检查自己的能力、情绪状态与事后恢复。'],
      questions: [
        ['在明确协商后，由我来安排亲密情境的流程会让我感到有吸引力。', '观察规划和掌握整体节奏是否构成兴趣。', '例如我会享受设计开始方式、变化顺序和结束条件，同时让对方事先知道可以怎样调整。'],
        ['我喜欢在互动中给出清楚指令，并观察对方自愿回应。', '观察发出指令与获得回应的互动张力。', '例如对方按约定完成一个动作、称呼或任务时，我会因这种自愿配合而感到投入。'],
        ['决定节奏快慢、暂停点或下一步，会增强我的参与感。', '观察时间和节奏控制是否具有吸引力。', '例如我喜欢根据对方反应让情境加快、放慢或暂时停住，而不是完全跟随预设流程。'],
        ['在对方把部分选择交给我时，我会感到被信任并愿意承担责任。', '观察权力交托是否同时带来情感意义和责任意识。', '例如对方同意让我在几个已协商选项中决定下一项，我会重视这种信任而不是把它理解成无限授权。'],
        ['我对规则、任务、许可或奖励一类结构化的引导有兴趣。', '观察持续或仪式化的权力结构是否吸引您。', '例如约定某些任务、请示方式或完成后的肯定，会比临时随意安排更有吸引力。'],
        ['看到对方在安全范围内因我的引导而专注或放松，会增强我的兴趣。', '观察对方的自愿反应是否是主导兴趣的重要反馈。', '例如对方明确表示安心、投入或享受时，我会比单纯“拥有决定权”更感到满足。']
      ]
    },
    {
      ...
      questions: [
        ['在边界清楚时，把一部分流程选择交给可信任的人会让我感到轻松或有吸引力。', '观察减少决策和自愿交托是否构成兴趣。', '例如事先选定可接受范围后，由对方决定其中的顺序和节奏，会让我更容易沉浸。'],
        ['收到清楚、具体而尊重边界的指令，会增强我的代入感。', '观察跟随明确指令是否比模糊猜测更有吸引力。', '例如对方说清楚希望我做什么、多久以及如何暂停，会比只说“听话一点”更让我安心投入。'],
        ['我喜欢在亲密幻想中暂时不用承担主要决策责任。', '观察交付是否提供从日常责任中暂时退出的体验。', '例如日常需要不断做决定时，我会被“有人可靠地带领，而我只需确认感受”的想象吸引。'],
        ['在确认可以随时改变主意后，“交出控制”的感觉会更吸引我。', '观察可撤回性是否是交付兴趣的基础。', '例如知道一个词、手势或直接说停都能立即改变情境，反而让我更愿意想象深入跟随。'],
        ['规则、许可、任务或被肯定的结构，会让我感到专注和被照顾。', '观察结构化跟随是否兼具秩序与情感意义。', '例如按约定完成一项任务并收到具体肯定，会让我觉得关系中的位置清楚而安心。'],
        ['我会对“对方了解我的边界，所以能安全地替我做部分决定”这一想象产生兴趣。', '观察信任与被理解是否支撑交付感。', '例如吸引我的不是失去全部自主，而是对方记得禁区、观察反应并在必要时主动减弱。']
      ]
    },
    {
      ...
      reflection: '您更喜欢发起挑战、回应挑战、追逐过程，还是最后重新确认安全与关系的位置？',
      suggestions: ['把角色内抵抗和现实停止信号设计成不会混淆的两套表达。', '不要使用会触发真实恐惧、创伤或身份羞辱的未知内容来“测试反应”。'],
      questions: [
        ['互相调皮、顶嘴或故意增加一点难度，会让我觉得互动更有趣。', '观察轻度挑战是否能增强游戏感和张力。', '例如对方明知规则却在约定范围内故意拖延或开玩笑，我会享受接下来如何回应。'],
        ['在事先协商清楚时，追逐、抓住或试图逃开的情节对我有吸引力。', '观察身体或叙事上的追逐感是否构成兴趣。', '例如双方先约定场地、力度和真正停止信号，再把“追上或逃开”当作短暂游戏。'],
        ['我喜欢“规则被小幅挑战，然后得到回应”的互动结构。', '观察规则与违规则是否形成您喜欢的往返。', '例如约定一个可以故意犯的小规则，让后续提醒、纠正或奖励成为情境的一部分。'],
        ['比起完全顺从，我有时更喜欢保留一点角色内的抵抗或讨价还价。', '观察您是否偏好带有能动性和拉扯感的跟随。', '例如即使最终愿意配合，也喜欢先用角色语言争辩几句，而不是从头到尾安静接受。'],
        ['面对对方在约定范围内的挑战，我会享受重新建立节奏或秩序。', '观察回应挑战是否能增强主导或互动投入。', '例如对方故意打乱一个小步骤时，我会把重新引导视为游戏，而不是现实中的不尊重。'],
    ...
    },
    {
      ...
      reflection: '吸引您的是刺激动作、强度控制、对方反应、照顾责任，还是几者组合？',
      suggestions: ['把感兴趣的动作与实际掌握的技术分开列出。', '从低强度开始并保留连续反馈，不把忍耐或沉默当成成功。'],
      questions: [
        ['在充分协商后，控制一种较强但可调节的感官刺激，会让我感兴趣。', '观察施加刺激与控制强度是否具有吸引力。', '例如在明确身体部位、强度范围和停止方式后，我会对逐步调整轻重感到投入。'],
        ['我会被对方自愿承受刺激时的表情、声音或身体回应吸引。', '观察参与者反馈是否是兴趣的重要来源。', '例如我关注的是对方明确享受、主动要求调整或表现专注，而不是只关注自己完成动作。'],
        ['精确掌握力度、节奏、位置和间隔本身，会让我觉得有趣。', '观察技术性和细致控制是否构成兴趣。', '例如会想研究怎样用较小风险制造清楚差异，而不是一味追求更强。'],
        ['我喜欢根据对方实时反馈不断调整，而不是机械执行预定强度。', '观察响应式控制是否增强参与感。', '例如对方呼吸、语言或手势变化时，我会停下来确认并改变节奏，这个互动过程本身很吸引我。'],
        ['“我负责让强烈体验保持在双方同意的范围内”这一责任感会增强我的投入。', '观察安全责任是否与主导兴趣相连。', '例如准备必要物品、复核身体状态和主动结束过度刺激，会让我觉得角色更加完整。'],
        ['结束较强刺激后照顾对方、检查状态和复盘，会影响我是否享受整个情境。', '观察施予后的照顾是否属于偏好的一部分。', '例如如果没有时间确认身体和情绪反应，我会觉得情境不完整，甚至不愿开始。']
      ]
    },
    {
      ...
      reflection: '您感兴趣的是身体强度、心理交付、期待感、情绪释放，还是只限幻想？',
      suggestions: ['分别标记只限幻想、可接受的身体部位、强度上限和禁止项目。', '疼痛、麻木、头晕、呼吸异常或恐惧不是需要用意志克服的评分证明。'],
      questions: [
        ['在安全可控时，较强的触觉、压力或冲击感可能对我有吸引力。', '观察强烈感官输入本身是否具有兴趣价值。', '例如在知道强度可立即降低的情况下，明确而集中的刺激会比轻微触碰更容易让我投入。'],
        ['在边界清楚、强度适中的情况下，短暂的不适可能让我更专注于当下。', '观察可控的不适是否会帮助您集中注意或进入特定状态。', '例如短暂、符合预期且能随时停止的刺激会让杂念减少；一旦感到真正的疼痛或不安，我仍会选择停止。'],
        ['等待下一次刺激、却不知道准确时点的期待感，会增强我的兴趣。', '观察可预测范围内的不确定节奏是否有吸引力。', '例如我知道刺激类型和上限，却不知道会在几秒后发生，这种等待比刺激本身更有张力。'],
        ['把感官强度暂时交给可信任的人，会增强我的交付感。', '观察接收刺激是否与权力交托相互增强。', '例如对方会持续观察并尊重信号时，我会因暂时不用决定每一下的节奏而更投入。'],
        ['较强体验后的放松、情绪释放或安静状态，对我有吸引力。', '观察强度后的状态变化是否是整体兴趣的一部分。', '例如我期待的不只是当下刺激，也包括结束后身体逐渐放松、情绪变得清楚或想安静休息。'],
    ...
    },
    {
      ...
      reflection: '您更在意视觉效果、身体感觉、被限制、负责限制、规则感，还是仪式性？',
      ...
      questions: [
        ...
        ['在信任条件下，暂时不能随意改变姿势的感觉可能对我有吸引力。', '观察作为接受方时的限制感是否带来交付或专注。', '例如知道随时能解除，但在短时间内保持约定姿势，会让我更专注于身体感受。'],
        ['我会对设计、检查和调整安全限制的操作过程感兴趣。', '观察作为操作方时的技术和责任兴趣。', '例如学习怎样留下空间、持续检查反应并准备快速解除，会让我觉得这一主题不仅是结果，也包括过程。'],
    ...
    },
    {
      ...
      questions: [
        ['清楚、有力量感的指令语言会增强我的情境兴趣。', '观察命令式语言是否具有吸引力。', '例如同一句请求如果用明确、沉稳且双方约定的语气表达，会比含糊暗示更让我投入。'],
        ['具体的赞美、肯定或被认可表现，会明显增强我的兴趣。', '观察积极语言反馈是否构成核心偏好。', '例如对方准确说出欣赏我的哪种反应、努力或配合，会比笼统称赞更打动我。'],
        ['在事先约定禁词后，带有羞耻或贬低反差的角色语言可能吸引我。', '观察角色内负面语言是否仅在安全边界中有兴趣。', '例如某些词在日常关系中不可接受，但在清楚知道是表演、可随时停下且事后会修复时具有戏剧张力。'],
        ['挑逗、故意延迟或用语言制造期待，会让我觉得有趣。', '观察语言是否能通过等待和暗示增强张力。', '例如对方先描述接下来可能发生什么，却保留准确时间和细节，会让我更投入想象。'],
        ['我对“角色里的话与现实评价相反”这种心理反差有兴趣。', '观察反差和禁忌感是否是吸引来源。', '例如现实中很被尊重的人在角色中暂时使用截然不同的称谓，但双方都清楚现实评价并未改变。'],
        ['角色语言结束后，明确恢复日常称呼和真实肯定对我很重要。', '观察语言去角色和情绪修复是否属于整体偏好。', '例如结束后说清刚才哪些话只属于情境，并用熟悉称呼确认关系，会让我更安心地看待整个体验。']
      ]
    },
    {
      ...
      reflection: '您感兴趣的是观看、被特定对象观看、镜面视角、表演感，还是影像留存？这些边界是否不同？',
      suggestions: ['分别讨论谁可以看、在哪里、是否记录、谁保管、何时删除。', '不让未同意的第三方被迫参与，也不以模糊场所规则代替同意。'],
      questions: [
        ['在对方明确同意时，专注观看对方的反应和动作会让我有兴趣。', '观察视觉关注他人是否是吸引力的重要来源。', '例如比起闭眼或只关注自己，我会喜欢观察对方的表情、姿势和情绪变化。'],
        ['被一个我信任且明确同意的人专注观看，可能会增强我的兴趣。', '观察成为注意中心是否具有吸引力。', '例如知道对方在欣赏而不是评判，并且我能随时要求停止观看时，会感到更投入。'],
    ...
    },
    {
      ...
      questions: [
        ...
        ['某种材质、气味、声音或触感对我有特别吸引力。', '观察非视觉感官线索是否集中承载偏好。', '例如皮革气味、织物摩擦声、金属触感或特定香味中的某一种，会反复出现在我的幻想中。'],
        ['我可能对某个身体部位或动作细节给予比整体更多的注意。', '观察局部线索是否在兴趣中占有较高权重。', '例如手、肩颈、背部、脚步或某种姿态会首先吸引我的注意，但这不必自动等于想要接触。'],
    ...
    },
    {
      ...
      reflection: '吸引您的是人数、被多人关注、观看关系互动、共享亲密、嫉妒张力，还是关系开放本身？',
      suggestions: ['把幻想内容与现实关系协议分开讨论，不用幻想推翻已有承诺。', '现实多人情境需要每个人直接表达同意、边界、隐私与退出安排。'],
      questions: [
        ['在幻想中，多名成年人均明确知情同意的亲密情境可能会吸引我。', '观察参与人数增加是否会增强想象中的吸引力。', '例如我会对三人或更多参与者都能直接协商、随时退出的情节产生好奇，即使并不打算在现实中实践。'],
        ['同时被不止一个人关注、照顾或回应的想象，会增强我的兴趣。', '观察多来源关注是否是吸引点。', '例如幻想中每个人都知道彼此存在，而我被多人共同注视、肯定或配合会觉得有张力。'],
        ['观看两位或更多知情同意者之间的互动，可能对我有吸引力。', '观察作为知情旁观者的兴趣。', '例如所有人都明确同意我在场并知道观看边界时，我会被他们之间的关系和回应吸引。'],
    ...
    },
    {
      ...
      reflection: '您更喜欢提供照顾、接受照顾、完成服务、得到感谢，还是共同恢复？',
      suggestions: ['事前询问每个人偏好的恢复方式，不假设拥抱或谈话适合所有人。', '照顾者同样可以需要休息、确认和情绪支持。'],
      questions: [
        ['在亲密互动中主动照顾对方的舒适和需要，会让我感到满足。', '观察照料行为本身是否具有吸引力。', '例如准备水、调整环境、记住对方不喜欢的刺激并主动询问状态，会让我觉得自己参与得更完整。'],
        ['被可信任的人细致照顾，会增强我的安全感和兴趣。', '观察接受照料是否支持投入。', '例如对方注意到我需要放慢、盖毯子、补水或暂时安静，会让我更愿意继续留在亲密状态。'],
        ['为对方完成约定的服务、任务或准备工作，可能是我喜欢的表达方式。', '观察服务行为是否承载亲密或角色意义。', '例如整理空间、准备物品或按清单完成一件事，会让我感到自己的投入被具体看见。'],
        ['对方具体感谢或肯定我的照顾，会明显增强这种体验的意义。', '观察照顾行为是否需要被回应和确认。', '例如听到对方说清哪一项帮助让其更安心，会比笼统说“很好”更让我感到满足。'],
        ['互动过程中定期询问“现在怎样、要不要调整”，会让我更安心而不是觉得扫兴。', '观察持续确认是否能增强而非破坏兴趣。', '例如用简短词语、数字或手势确认强度，不会打断我的投入，反而让我知道自己的感受被重视。'],
        ['结束后的安抚、补给、独处或次日联系，是我评估整个情境的重要部分。', '观察事后照顾和恢复是否决定整体体验。', '例如我可能需要拥抱聊天，也可能需要安静独处；只要这种需要被提前尊重，就会更愿意进入情境。']
      ]
    }
  ];
  ...
  const pairInterpretations = {
    'intensityGiving|intensityReceiving': '您可能同时对施予和接收可控强度感兴趣，角色位置具有一定流动性。两项分别高不等于任何一次互动中都愿意交换角色，仍需逐次说明。',
    'following|leading': '您可能同时享受引领与跟随，偏好会随对象、信任、情境或当天状态变化。与其急于固定为某个标签，不如记录不同角色成立的具体条件。',
    'care|intimacy': '情感联结和照顾确认可能共同构成您的核心吸引力；互动是否温暖、可回应、能够妥善结束，可能比主题强度更重要。',
    'novelty|roleplay': '新鲜感与叙事代入可能彼此增强。您可能更喜欢通过新角色和新情节探索，而不一定追求更高身体强度。',
    'challenge|leading': '您可能享受“挑战—回应—重新建立节奏”的往返。需要特别把角色内挑战与现实停止信号分开。',
    'challenge|following': '您的跟随偏好可能保留明显的游戏性和能动性；自愿交付并不要求从头到尾表现安静或完全顺从。',
    'atmosphere|objects': '感官氛围和具体意象可能共同触发兴趣。与其只讨论活动名称，描述光线、材质、服装和空间往往更能帮助沟通。',
    'intimacy|multiPerson': '多人或关系主题与亲密联结可以同时重要。您可能关注的不只是人数，也包括每个人是否被看见、关系是否透明以及情感安全如何维持。',
    'leading|restraint': '限制与主导可能相互增强，但技术操作和权力引领是两种不同能力，需要分别协商与学习。',
    'following|restraint': '限制感可能帮助您进入跟随状态；是否能快速解除、如何确认身体状态以及谁负责观察，会直接影响安全感。',
  ...
  function renderQuestions() {
    ...
    dimensions.forEach((dimension, dimensionIndex) => {
      ...
      dimension.questions.forEach(question => {
        ...
        focus.append(element('strong', '', '本题用意：'), document.createTextNode(`${question[1]} 这里评估的是主题本身的当前吸引力，不要求您产生性吸引、拥有相关经验或愿意现实实践。`));
  ...
  function scoreLevel(score) {
    if (score < 1.25) return { key: 'low', label: '当前兴趣较低', text: '这项主题目前较少带来幻想、审美或实践兴趣。低分是完整有效的偏好，也不表示您需要改变。' };
  ...
  function getProfilePattern(ranked) {
    ...
    if (overall < 1.25) return { label: '整体兴趣较低画像', text: '十五个维度目前大多兴趣较低。这是一种完整有效的画像，可能与无性恋谱系体验、低兴趣阶段、较少幻想或本量表未覆盖您的兴趣有关；结果不表示功能问题。' };
    if (core.length >= 5 || clear.length >= 10) return { label: '多维开放画像', text: '多个维度都有较明确兴趣，说明您的偏好可能具有较高广度。广度不等于愿意实践更多项目，逐项边界仍比总体开放度重要。' };
  ...
  function renderTypeJudgment(ranked) {
    ...
    if (ranked[0].score < 1.25) {
      target.innerHTML = '<p class="result-lead">您目前没有明显突出的量表内偏好。多项低分可以自然对应无性恋谱系、低兴趣阶段、较少幻想，或单纯不喜欢本量表所列主题；它不构成缺失或异常。</p>';
      return;
    }
  ...
  function renderMainInterpretation(ranked) {
    ...
    document.getElementById('mainInterpretation').innerHTML = `
      <section class="insight-card">
        ...
        <p>组合解读只是把结果改写成更便于沟通的线索。它不能替您决定是否实践，也不能被任何人当作同意证明。</p>
      </section>`;
  }
  ...
  function buildReflectionActions(ranked) {
    ...
    return [
      ...
      {
        title: '保留分享与同意边界',
        text: '只分享您愿意分享的部分。量表分数不是邀请、承诺或同意；本报告也不测量性取向、性欲水平、身体反应、性功能、风险承受能力或实践技能。'
      }
    ];
  }
