...
PrismSelf 是一个以静态网页形式呈现的中文知识库，围绕性别理论、心理概念与人际关系议题整理概念分析、专题指南、社群记录、共鸣刻度、自评量表和关系沟通工具。

项目供访问者学习、自我探索和个人理解辅助使用。

## 功能概览

- 知识入口：[index.html](./index.html) 提供知识图谱式入口、分类导航、搜索、更新记录和内容卡片。
- 主题分析：[Analyses](./Analyses) 收录概念辨析、主题分析等页面。
- 专题指南：[Guides](./Guides) 收录指南、术语表等页面。
- 社群观察：[Topics](./Topics) 收录调查报告、专题对谈等页面。
- 共鸣刻度：[Bingos](./Bingos) 收录宾果类互动页面。
- 自评量表：[Scales](./Scales) 收录个人测试页面。
- 关系工具：[Tools](./Tools) 收录关系沟通梳理工具。
