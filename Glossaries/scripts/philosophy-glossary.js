...
const terms = [
  ...
  { zh: "意向性", en: "Intentionality", cat: "mind", aliases: "指向性", desc: "心灵状态指向某个对象或内容的特征，例如相信某事、害怕某物、希望某结果。", note: "这里的 intentionality 指心灵的“关于某物/指向某物”特征，不等于日常英语里的“故意”；“关于性”虽见于少量译述，但歧义较大。" },
  ...
  { zh: "虚无", en: "Nothingness", cat: "being", desc: "与存在相对的概念，常用于追问缺席、否定和存在基础。", note: "存在主义或形而上学中的 nothingness 不等于普通空白，也不应未经说明与道家“无”直接互译。" },
