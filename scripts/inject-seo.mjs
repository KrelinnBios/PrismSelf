...
const pages = {
  ...
  'Bingos/Gender-Spectrum-Resonance.html': { desc: '性别身份与认同谱系共鸣刻度卡，通过条目自评探索性别体验与认同。' },
  ...
  'Glossaries/Psychology-Glossary.html': { desc: '心理学术语表，以可搜索术语表形式收录 200 个心理学入门常见概念、研究方法与理论流派。' },
  'Glossaries/SOGIESC-Glossary.html': { desc: 'SOGIESC 术语表，以可搜索术语表形式收录 200 个性取向、性别认同与表达以及性别特征相关概念。' },
  'Glossaries/Sociology-Glossary.html': { desc: '社会学术语表，以可搜索术语表形式收录 200 个社会学入门常见概念、研究方法与理论视角。' },
