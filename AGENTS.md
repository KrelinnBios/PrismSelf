...
- 代码与工程文件采用 MIT License；有权许可的原创文档和网站预设内容采用 CC BY-NC-SA 4.0，仅授权非商业使用且要求改编内容以相同方式共享；第三方材料和参与者表达按各自权利状态处理。
...
| `Guides/` | 长篇指南、术语表和科普页面；共享样式为 `guide-common.css` |
...
| `og-image/` | 社交分享卡片图（PNG 用于实际投放，SVG 为设计源） |
